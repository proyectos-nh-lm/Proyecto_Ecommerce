...
!(function (e, t) {
  ...
  function o(e) {
    var t = $(e.target).closest('div[role="menuitem"]')[0],
      e = b(t),
      n = l.getOptions(),
      a = "";
    switch ((console.log(t), console.log(e), e)) {
      case "toggle-daily":
        a = "day";
        break;
      case "toggle-weekly":
        ...
        break;
      case "toggle-monthly":
        (n.month.visibleWeeksCount = 0), (a = "month");
        break;
      case "toggle-weeks2":
        (n.month.visibleWeeksCount = 2), (a = "month");
        break;
      case "toggle-weeks3":
        (n.month.visibleWeeksCount = 3), (a = "month");
        break;
      case "toggle-narrow-weekend":
        (n.month.narrowWeekend = !n.month.narrowWeekend),
          (n.week.narrowWeekend = !n.week.narrowWeekend),
          (a = l.getViewName()),
          (t.querySelector("input").checked = n.month.narrowWeekend);
        break;
      case "toggle-start-day-1":
        (n.month.startDayOfWeek = n.month.startDayOfWeek ? 0 : 1),
          (n.week.startDayOfWeek = n.week.startDayOfWeek ? 0 : 1),
          (a = l.getViewName()),
          (t.querySelector("input").checked = n.month.startDayOfWeek);
        break;
      case "toggle-workweek":
        (n.month.workweek = !n.month.workweek),
          (n.week.workweek = !n.week.workweek),
          (a = l.getViewName()),
          (t.querySelector("input").checked = !n.month.workweek);
    }
    l.setOptions(n, !0), l.changeView(a, !0), m(), f(), p();
  }
  function r(e) {
    switch (b(e.target)) {
      case "move-prev":
  ...
  function s(e) {
    var t,
      n,
      e = b($(e.target).closest('div[role="menuitem"]')[0]);
    (e = e),
      (t = document.getElementById("calendarName")),
      (e = findCalendar(e)),
      (n = []).push(
      ...
      n.push('<span class="calendar-name">' + e.name + "</span>"),
      (t.innerHTML = n.join("")),
      (i = e);
  }
  function u(e) {
    var t = e.start
        ? new Date(e.start.getTime()).format("DD/MM/YYYY")
        : new Date(),
      e = e.end
        ? new Date(e.end.getTime()).format("DD/MM/YYYY")
        : moment().add(1, "hours").toDate();
    n && l.openCreationPopup({ start: t, end: e });
  }
  function h(e) {
    var t = e.target.value,
      n = e.target.checked,
      e = document.querySelector(".lnb-calendars-item input"),
  ...
  function m() {
    var e = document.getElementById("calendarTypeName"),
      ...
      n =
        "day" === a
          ? ((a = "Daily"), "calendar-icon feather feather-list fs-12 me-1")
          : "week" === a
          ? ((a = "Weekly"),
            "calendar-icon feather feather-umbrella fs-12 me-1")
          : 2 === n.month.visibleWeeksCount
          ? ((a = "2 weeks"),
            "calendar-icon feather feather-sliders fs-12 me-1")
          : 3 === n.month.visibleWeeksCount
          ? ((a = "3 weeks"), "calendar-icon feather feather-framer fs-12 me-1")
          : ((a = "Monthly"), "calendar-icon feather feather-grid fs-12 me-1");
    (e.innerHTML = a), (t.className = n);
  }
  function k(e) {
    return moment([
      l.getDate().getFullYear(),
      l.getDate().getMonth(),
      l.getDate().getDate(),
    ]).format(e);
  }
  function f() {
    ...
    ("month" === n &&
      ...
      ? a.push(k("DD.MM.YY"))
      : (a.push(moment(l.getDateRangeStart().getTime()).format("DD/MM/YYYY")),
        a.push(" ~ "),
        a.push(moment(l.getDateRangeEnd().getTime()).format("DD/MM/YYYY"))),
      (e.innerHTML = a.join(""));
  }
  function p() {
    l.clear(),
  ...
  (l = new t("#tui-calendar-init", {
    ...
    beforeCreateSchedule: function (e) {
      ...
      var t = (e = e).calendar || findCalendar(e.calendarId),
        e = {
          id: String(chance.guid()),
          title: e.title,
          isAllDay: e.isAllDay,
    ...
    beforeUpdateSchedule: function (e) {
      ...
      console.log("beforeUpdateSchedule", e),
        n && !n.isAllDay && "allday" === t.category && (n.category = "time"),
    ...
    f(),
    p(),
    $(".menu-navi").on("click", r),
    $('.dropdown-menu div[role="menuitem"]').on("click", o),
    $("#lnb-calendars").on("change", h),
    $("#btn-save-schedule").on("click", d),
    $("#btn-new-schedule").on("click", u),
    $("#dropdownMenu-calendars-list").on("click", s),
