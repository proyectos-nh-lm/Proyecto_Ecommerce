!(function (t, e) {
  ...
  function l() {
    ...
    for (t of arguments)
      for (var s of t)
        u(s)
          ? i[s.value] || (e.push(s), (i[s.value] = 1))
        ...
        if (!this.state.mainEvents || !t) {
          ...
          t && t.disconnect(),
            "mix" == this.settings.mode &&
              t.observe(this.DOM.input, { childList: !0 });
        }
      },
      bindGlobal(t) {
        var e,
      ...
      callbacks: {
        onFocusBlur(t) {
          var e = t.target ? this.trim(t.target.textContent) : "",
            i = this.settings,
            s = t.type,
            a = 0 <= i.dropdown.enabled,
            n = { relatedTarget: t.relatedTarget },
            o =
              this.state.actions.selectOption &&
              (a || !i.dropdown.closeOnSelect),
            a = this.state.actions.addNew && a,
            r =
              t.relatedTarget &&
                ...
                : ("blur" == s &&
                    ...
                    (o = i.enforceWhitelist
                      ? !!this.getWhitelistItem(
                          null == (o = this.value) || null == (a = o[0])
                            ? void 0
                            : a.value
                        )
                      : i.keepInvalidTags),
                    "select" == this.settings.mode && r && (e = ""),
        ...
        onKeydown(t) {
          var e = this.settings,
            i =
              ("select" == e.mode &&
                ...
                "Tab" != t.key &&
                t.preventDefault(),
              this.trim(t.target.textContent));
          if (
            ...
            switch (t.key) {
              ...
              case "Backspace":
                ...
                var s,
                  ...
                  l = o.anchorNode.previousSibling,
                  l =
                    1 == o.anchorNode.nodeType ||
                    (!o.anchorOffset &&
                      l &&
                      1 == l.nodeType &&
                      o.anchorNode.previousSibling),
                  d = p(this.DOM.input.innerHTML),
                  h = this.getTagElms();
                if ("edit" == e.backspace && l)
                  return (
                    (s =
                      1 == o.anchorNode.nodeType
                        ? null
                  ...
                  ((r || l) && 1 == o.anchorNode.nodeType
                    ? (a =
                        0 == o.anchorOffset
                          ...
                          : h[o.anchorOffset - 1])
                    : r
                    ? (a = o.anchorNode.nextElementSibling)
                    : l && (a = l),
                ...
                if (
                  "Range" != o.type &&
                  !o.anchorOffset &&
                  o.anchorNode == this.DOM.input &&
                  "Delete" != t.key
                )
                  return void t.preventDefault();
                if ("Range" != o.type && a && a.hasAttribute("readonly"))
                  return void this.placeCaretAfterNode(c(a));
                clearTimeout(w),
                  (w = setTimeout(() => {
                    var t = document.getSelection(),
                      e = p(this.DOM.input.innerHTML),
                      t = !r && t.anchorNode.previousSibling;
                    if (e.length >= d.length && t)
                      if (f.call(this, t) && !t.hasAttribute("readonly")) {
                        if (
                          (this.removeTags(t),
          ...
          switch (t.key) {
            ...
            case "ArrowRight":
              ...
              if (g && e.autoComplete.rightKey)
                return void this.addTags([g], !0);
              break;
            case "Tab":
              g = "select" == e.mode;
              if (!i || g) return !0;
        ...
        onInput(t) {
          ...
          var t = this.input.normalize.call(this),
            e = t.length >= this.settings.dropdown.enabled,
            i = { value: t, inputElm: this.DOM.input };
          (i.isValid = this.validateTag({ value: t })),
        ...
        onMixTagsInput(t) {
          var e,
            ...
            h = [].map.call(r, (t) => this.tagData(t).value);
          if (
            ...
            this.value.slice().forEach((t) => {
              t.readonly &&
                !h.includes(t.value) &&
                l.appendChild(this.createTagElem(t));
            }),
            l.childNodes.length &&
              (d.insertNode(l), this.setRangeAtStartEnd(!1, l.lastChild)),
            r.length != o)
          )
            ...
            if (
              ...
              if (
                ...
                (d =
                  (o = d.toString().slice(0, d.endOffset)).split(n.pattern)
                    .length - 1),
                (i = (e = o.match(n.pattern))
                  ? o.slice(o.lastIndexOf(e[e.length - 1]))
                  : i))
              ) {
                if (
                ...
                try {
                  (a =
                    (a = this.state.flaggedTags[this.state.tag.baseOffset])
                      .prefix == this.state.tag.prefix &&
                    a.value[0] == this.state.tag.value[0]),
            ...
            setTimeout(() => {
              this.update({ withoutChangeEvent: !0 }),
                ...
                this.state.tag &&
                  this.dropdown[s ? "show" : "hide"](this.state.tag.value);
            }, 10);
          }
        },
        onInputIE(t) {
        ...
        onEditTagBlur(t) {
          if (
            ...
            var e = this.settings,
              ...
              s = this.tagData(i).__originalData,
              a = i.innerHTML != i.__tagifyTagData.__originalHTML,
              n = this.validateTag({ [e.tagTextProp]: t });
            if (t)
              if (a) {
                if (
                  ((a = this.hasMaxTags()),
                  (t = g({}, s, {
                    [e.tagTextProp]: this.trim(t),
                    value: t,
                    __isValid: n,
                  })),
                  e.transformTag.call(this, t, s),
                  !0 !==
                    (n = (!a || !0 === s.__isValid) && this.validateTag(t)))
                ) {
                  if (
                    (this.trigger("invalid", { data: t, tag: i, message: n }),
                    e.editTags.keepInvalid)
                  )
                    return;
                  e.keepInvalidTags ? (t.__isValid = n) : (t = s);
                } else
                  e.keepInvalidTags &&
                    (delete t.title, delete t["aria-invalid"], delete t.class);
                this.onEditTagDone(i, t);
              } else this.onEditTagDone(i, s);
        ...
        onDoubleClickScope(t) {
          ...
          t &&
            s.userInput &&
            ((e = t.classList.contains(this.settings.classNames.tagEditing)),
            (i = t.hasAttribute("readonly")),
            "select" == s.mode ||
              s.readonly ||
              e ||
              i ||
    ...
    g(
      ...
      (this.getPersistedData =
        ...
        (t) => {
          let e,
            i = "/" + t;
          if (1 == localStorage.getItem(T + s + "/v", 1))
            try {
              e = JSON.parse(localStorage[T + s + i]);
            } catch (t) {}
          return e;
        })),
      (this.setPersistedData = (n = e.id)
        ? (localStorage.setItem(T + n + "/v", 1),
          (t, e) => {
            var i = "/" + e,
              s = JSON.stringify(t);
            t &&
              e &&
              (localStorage.setItem(T + n + i, s),
        ...
        (t) => {
          ...
          if (t) localStorage.removeItem(e + t);
            ...
            for (var i in localStorage)
              i.includes(e) && localStorage.removeItem(i);
        })),
    ...
    ((y.prototype = {
      _dropdown: {
          ...
          "manual" != h.position &&
            ...
            (h =
              ...
              Math.max(
                ...
                ? h.position
                : "all"),
            (d = this.DOM["input" == h ? "input" : "scope"]),
            (t = t || o.clientHeight),
            this.state.dropdown.visible) &&
            ((d =
              "text" == h
                ? ((s = (e = this.getCaretGlobalPosition()).bottom),
                  (i = e.top),
                  (a = e.left),
                  "auto")
                : ((n = (function (t) {
                  ...
                  (i = (e = d.getBoundingClientRect()).top - n.top),
                  (s = e.bottom - 1 - n.top),
                  (a = e.left - n.left),
                  e.width + "px")),
            (i = Math.floor(i)),
            (s = Math.ceil(s)),
            (r = void 0 === r ? l - e.bottom < t : r),
            (o.style.cssText =
              "left:" +
              ...
              ";" +
              (r
                ? "top: " + (i + window.pageYOffset) + "px"
                : "top: " + (s + window.pageYOffset) + "px")),
            o.setAttribute("placement", r ? "top" : "bottom"),
            o.setAttribute("position", h));
        },
        events: {
          binding(t = !0) {
              ...
              switch (t.key) {
                ...
                case "Up":
                  t.preventDefault(),
                    (i =
                      ...
                      ((e = this.DOM.dropdown.content.children),
                      (i =
                        e[
                          "ArrowUp" == t.key || "Up" == t.key ? e.length - 1 : 0
                        ])),
                    (s = this.dropdown.getSuggestionDataByNode(i)),
                ...
                case "Tab":
                  return "mix" == this.settings.mode ||
                    ...
                    ? !0
                    : (t.preventDefault(),
                      (e = this.dropdown.getMappedValue(s)),
                      this.input.autocomplete.set.call(this, e),
                      !1);
                case "Enter":
                  t.preventDefault(),
                    this.settings.hooks
                      ...
                      .then(() => {
                        if (i) return this.dropdown.selectOption(i);
                        this.dropdown.hide(),
                          "mix" != this.settings.mode &&
        ...
        getSuggestionDataByNode(t) {
          t = t ? +t.getAttribute("tagifySuggestionIdx") : -1;
        ...
        selectOption(t) {
          var e,
            i,
            s = this.settings.dropdown,
            a = s.clearOnSelect,
            s = s.closeOnSelect;
          t
            ? ((e = t.getAttribute("tagifySuggestionIdx")),
              (i = this.suggestedListItems[+e]),
              this.trigger("dropdown:select", { data: i, elm: t }),
              e && i
                ? (this.state.editing
                    ? this.onEditTagDone(
                        null,
                        g({ __isValid: !0 }, this.normalizeTags([i])[0])
                      )
                    : this[
          ...
          var s,
            ...
            o =
              ...
              (t =
                "select" == a.mode &&
                this.value.length &&
                this.value[0][a.tagTextProp] == t
                  ? ""
                  : t),
              []),
            r = [],
            l = a.whitelist,
            e = 0 <= n.maxItems ? n.maxItems : 1 / 0,
            d = n.searchKeys,
            h = 0;
          if (!t || !d.length)
            return (
              (o = a.duplicates
                ? l
                : l.filter((t) => !this.isTagDuplicate(u(t) ? t.value : t))),
              (this.state.dropdown.suggestions = o).slice(0, e)
            );
          for (
            s = n.caseSensitive ? "" + t : ("" + t).toLowerCase();
            h < l.length;
            h++
          ) {
            let t, e;
            var g = l[h] instanceof Object ? l[h] : { value: l[h] },
              p = Object.keys(g).some((t) => d.includes(t)) ? d : ["value"],
              c =
                n.fuzzySearch && !i.exact
                  ? ((c = p
                      .reduce((t, e) => t + " " + (g[e] || ""), "")
                      .toLowerCase()
                      .trim()),
                    n.accentedSearch && ((c = m(c)), (s = m(s))),
                    (t = 0 == c.indexOf(s)),
                    (e = c === s),
                    (function (e, t) {
                      return t
                  ...
                  : ((t = !0),
                    p.some((t) => {
                      t = "" + (g[t] || "");
                      return (
                        n.accentedSearch && ((t = m(t)), (s = m(s))),
                        n.caseSensitive || (t = t.toLowerCase()),
                        (e = t === s),
                        i.exact ? t === s : 0 == t.indexOf(s)
                      );
                    })),
              p = !a.duplicates && this.isTagDuplicate(u(g) ? g.value : g);
            c &&
              !p &&
              (e && t
                ? r.push(g)
                : "startsWith" == n.sortby && t
                ? o.unshift(g)
                : o.push(g));
          }
          return (
            (this.state.dropdown.suggestions = r.concat(o)),
            "function" == typeof n.sortby
              ? n.sortby(r.concat(o), s)
              : r.concat(o).slice(0, e)
          );
        },
        getMappedValue(t) {
        ...
        createListHTML(t) {
          return g([], t)
            .map((t, e) => {
              var i = this.dropdown.getMappedValue(
                  (t =
                ...
                i =
                  ((t.value = "string" == typeof i ? n(i) : i),
                  this.settings.templates.dropdownItem.apply(this, [t, this]));
              return i
      ...
      parseHTML: t,
      templates: {
        wrapper: (t, e) => `<tags class="${e.classNames.namespace} ${
        ...
        tag(t, e) {
          ...
          return `<tag title="${t.title || t.value}"
            ...
            <div>
                <span class="${i.classNames.tagText}">${
      ...
      applySettings(i, t) {
        ...
        s.disabled && (s.userInput = !1),
          (this.TEXTS = a(a({}, b), s.texts || {})),
          ("select" != s.mode && s.userInput) || (s.dropdown.enabled = 0),
          (s.dropdown.appendTarget =
            t.dropdown && t.dropdown.appendTarget
              ? t.dropdown.appendTarget
              : document.body);
        t = this.getPersistedData("whitelist");
        Array.isArray(t) &&
          (this.whitelist = Array.isArray(s.whitelist) ? l(s.whitelist, t) : t);
      },
      getAttributes(t) {
        var e,
      ...
      placeCaretAfterNode(t) {
        ...
        t &&
          t.parentNode &&
          ((e = t.nextSibling),
          (s = (i = window.getSelection()).getRangeAt(0)),
          i.rangeCount) &&
          (s.setStartAfter(e || t),
          s.collapse(!0),
          i.removeAllRanges(),
        ...
        if (a) {
          if (!(o instanceof Object && "editable" in o) || o.editable)
            return (
              ...
              a.addEventListener("focus", r.onEditTagFocus.bind(this, e)),
              ...
              a.addEventListener("keydown", (t) =>
                r.onEditTagkeydown.call(this, t, e)
              ),
              a.focus(),
              this.setRangeAtStartEnd(!1, a),
              t.skipValidation || (d = this.editTagToggleValidity(e)),
              (a.originalIsValid = d),
      ...
      setRangeAtStartEnd(e, i) {
        ...
        try {
          1 <= s.rangeCount &&
            ["Start", "End"].forEach((t) =>
              s.getRangeAt(0)["set" + t](i, e || i.length)
            );
        } catch (e) {}
      },
      injectAtCaret(t, e) {
        ...
        autocomplete: {
          suggest(t) {
            ...
            this.settings.autoComplete.enabled &&
              ((i = (e = (t =
                "string" == typeof (t = t || {}) ? { value: t } : t).value
                ? "" + t.value
                : "")
            ...
            return (
              ...
              ("mix" == this.settings.mode
                ? this.replaceTextWithNode(
                    document.createTextNode(this.state.tag.prefix + t)
                  )
                : (this.input.set.call(this, t), this.setRangeAtStartEnd()),
              this.input.autocomplete.suggest.call(this),
              this.dropdown.hide(),
              !0)
            );
      ...
      getTagElms(...t) {
        t = "." + [...this.settings.classNames.tag.split(" "), ...t].join(".");
      ...
      isTagDuplicate(i, s, a) {
        var n = this.settings;
        return (
          "select" != n.mode &&
          this.value.reduce(
            (t, e) =>
              o(this.trim("" + i), e.value, s || n.dropdown.caseSensitive) &&
              a != e.__tagId
                ? t + 1
                : t,
            0
      ...
      getInvalidTagAttrs(t, e) {
        return {
          "aria-invalid": !0,
          class: (
            `${t.class || ""} ` + this.settings.classNames.tagNotAllowed
          ).trim(),
          title: e,
        };
      },
      ...
      normalizeTags(t) {
        ...
        if ("string" == typeof (t = "number" == typeof t ? t.toString() : t)) {
          if (!t.trim()) return [];
          t = r(t);
        } else i && (t = [].concat(...t.map((t) => (t.value ? t : r(t)))));
        return (t =
          e &&
          (t.forEach((t) => {
            var e = o.map((t) => t.value),
              ...
              i =
                1 <
                (i = this.settings.duplicates
                  ? i
                  : i.filter((t) => !e.includes(t.value))).length
      ...
      parseMixTags(t) {
        ...
        return (
          ...
          this.getTagElms().forEach((t, e) => this.tagData(t, p[e])),
          this.update({ withoutChangeEvent: !0 }),
          t
        );
      },
      replaceTextWithNode(t, e) {
        ...
        if (this.state.tag || e)
          return (
            ...
            (s = (i = window.getSelection()).anchorNode),
                ...
                : ("select" == o.mode && (e = !1),
                  ...
                  t.forEach((t) => {
                    ...
                    if (
                      ...
                      if (a) return;
                      g(i, this.getInvalidTagAttrs(t, t.__isValid), {
                        __preInvalidData: s,
                      }),
                  ...
                  this.dropdown.refilter(),
                  n))
            : ("select" == o.mode && this.removeAllTags(), n)
        );
      },
      addMixTags(t) {
        ...
        return (
          t.forEach((t) => {
            ...
            i.appendChild(t), this.insertAfterTag(t);
          }),
          e
      ...
      prefixedTextToTag(t) {
        ...
        return (
          ...
          this.value.push(t),
          this.update(),
          s || ((i = this.insertAfterTag(e) || e), this.placeCaretAfterNode(i)),
          (this.state.tag = null),
      ...
      reCheckInvalidTags() {
        ...
        this.getTagElms(t.classNames.tagNotAllowed).forEach((t, e) => {
          ...
          if (!0 === a && !s)
            return (
              (i = i.__preInvalidData || { value: i.value }),
              this.replaceTag(t, i)
            );
          t.title = s || a;
        });
      ...
      removeTagsFromValue(t) {
        (t = Array.isArray(t) ? t : [t]).forEach((t) => {
          (t = this.tagData(t)), (t = this.getTagIdx(t));
            ...
            t.childNodes.forEach((t) => {
              ...
              ["B", "I", "U"].includes(t.tagName)
                ...
                : f.call(a, t) &&
                  e &&
                  (e.__removed ||
                    (s += n[0] + JSON.stringify(r(e, a.dataProps)) + n[1]));
            });
          })(this.DOM.input),
          s
        );
      },
    }).removeTag = y.prototype.removeTags),
    y
  );
});
