!(function (h) {
  ...
  function s(e, t, n) {
    for (
      var r,
        ...
        a,
        n = (e = h(e)).clone(t, n),
        i = e.find("textarea").add(e.filter("textarea")),
        l = n.find("textarea").add(n.filter("textarea")),
        c = e.find("select").add(e.filter("select")),
        d = n.find("select").add(n.filter("select")),
        s = e.find("canvas").add(e.filter("canvas")),
        f = n.find("canvas").add(n.filter("canvas")),
        p = 0,
        u = i.length;
      p < u;
      ++p
    ...
    for (p = 0, u = c.length; p < u; ++p)
      for (r = 0, o = c[p].options.length; r < o; ++r)
        !0 === c[p].options[r].selected && (d[p].options[r].selected = !0);
    for (p = 0, u = s.length; p < u; ++p)
      (a = s[p].getContext("2d")) &&
        (f[p].getContext("2d").drawImage(s[p], 0, 0),
        h(f[p]).attr("data-jquery-print", a.canvas.toDataURL()));
    return n;
  }
  function f(t) {
    var n = h("");
  ...
  function u(e, t) {
    p(window.open(), e, t).always(function () {
      try {
        t.deferred.resolve();
      } catch (e) {
  ...
  h.print = h.fn.print = function () {
    y((e = (e = this) instanceof h ? e.get(0) : e))
      ? ((o = h(e)), 0 < arguments.length && (t = arguments[0]))
      : 0 < arguments.length
      ? y((o = h(arguments[0]))[0])
        ? 1 < arguments.length && (t = arguments[1])
        : ((t = arguments[0]), (o = h("html")))
      : (o = h("html"));
    var e = {
        globalStyles: !0,
        mediaPrint: !1,
    ...
    if (
      (t.globalStyles
        ? (n = h("style, link, meta, base, title"))
        : t.mediaPrint && (n = h("link[media=print]")),
      t.stylesheet)
    ) {
      (h.isArray || Array.isArray)(t.stylesheet) ||
        (t.stylesheet = [t.stylesheet]);
      for (var r = 0; r < t.stylesheet.length; r++)
        n = h.merge(
          n,
          h('<link rel="stylesheet" href="' + t.stylesheet[r] + '">')
        );
    }
    var o = s(o, !0, !0);
    (o = h("<span/>").append(o)).find(t.noPrintSelector).remove(),
      o.append(s(n)),
      t.title &&
        (0 === (d = h("title", o)).length &&
          ((d = h("<title />")), o.append(d)),
        d.text(t.title)),
      o.append(f(t.append)),
      ...
      t.manuallyCopyFormValues &&
        (o.find("input").each(function () {
          var e = h(this);
          e.is("[type='radio']") || e.is("[type='checkbox']")
            ? e.prop("checked") && e.attr("checked", "checked")
            : e.attr("value", e.val());
        }),
      ...
      try {
        (a = d),
          ...
          p(
            (l =
              0 === c
                ? h('<iframe height="0" width="0" border="0" wmode="Opaque"/>')
                    .prependTo("body")
