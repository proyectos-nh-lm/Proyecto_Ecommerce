function iformat(t) {
  var e = t.element;
  return $(
    '<span class="hstack gap-3"><i class=" ' +
      $(e).data("icon") +
      '"></i> ' +
      t.text +
      "</span>"
...
$("[data-select2-selector='default']").select2({ theme: "bootstrap-5" }),
  $(
    "[data-select2-selector='icon'], [data-select2-selector='visibility'], [data-select2-selector='privacy'"
  ).select2({
    theme: "bootstrap-5",
...
//# sourceMappingURL=select2-active.min.js.map
