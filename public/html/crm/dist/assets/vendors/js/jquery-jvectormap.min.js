!(function (t) {
  ...
  t.fn.vectorMap = function (t) {
    ...
    if ("addMap" === t) jvm.Map.maps[arguments[1]] = arguments[2];
      ...
      if (("set" === t || "get" === t) && s[t][arguments[1]])
        return (
          (e = arguments[1].charAt(0).toUpperCase() + arguments[1].substr(1)),
          a[t + e].apply(a, Array.prototype.slice.call(arguments, 2))
        );
  ...
  (function (t) {
    ...
    if (h.event.fixHooks)
      for (var a = t.length; a; ) h.event.fixHooks[t[--a]] = h.event.mouseHooks;
    var s = (h.event.special.mousewheel = {
      ...
      setup: function () {
        ...
        h.data(this, "mousewheel-line-height", s.getLineHeight(this)),
          h.data(this, "mousewheel-page-height", s.getPageHeight(this));
      },
      teardown: function () {
      ...
      getLineHeight: function (t) {
        return parseInt(
          h(t)
            ["offsetParent" in h.fn ? "offsetParent" : "parent"]()
            .css("fontSize"),
          10
        );
      },
    ...
    function i(t) {
      var e,
        ...
        r = 0;
      if (
        (((t = h.event.fix(a)).type = "mousewheel"),
        "detail" in a && (r = -1 * a.detail),
        "wheelDelta" in a && (r = a.wheelDelta),
        "wheelDeltaY" in a && (r = a.wheelDeltaY),
        "wheelDeltaX" in a && (n = -1 * a.wheelDeltaX),
        "axis" in a && a.axis === a.HORIZONTAL_AXIS && ((n = -1 * r), (r = 0)),
        (i = 0 === r ? n : r),
        "deltaY" in a && (i = r = -1 * a.deltaY),
        "deltaX" in a && ((n = a.deltaX), 0 === r) && (i = -1 * n),
        0 !== r || 0 !== n)
      )
        return (
          1 === a.deltaMode
            ? ((i *= e = h.data(this, "mousewheel-line-height")),
              (r *= e),
              (n *= e))
            : 2 === a.deltaMode &&
              ((i *= e = h.data(this, "mousewheel-page-height")),
              (r *= e),
              (n *= e)),
          (e = Math.max(Math.abs(r), Math.abs(n))),
          (!l || e < l) && p(a, (l = e)) && (l /= 40),
          p(a, e) && ((i /= 40), (n /= 40), (r /= 40)),
          (i = Math[1 <= i ? "floor" : "ceil"](i / l)),
          (n = Math[1 <= n ? "floor" : "ceil"](n / l)),
          (r = Math[1 <= r ? "floor" : "ceil"](r / l)),
          (t.deltaX = n),
          (t.deltaY = r),
          (t.deltaFactor = l),
          (t.deltaMode = 0),
    ...
    function p(t, e) {
      return (
        s.settings.adjustOldDeltas && "mousewheel" === t.type && e % 120 == 0
      );
    }
    h.fn.extend({
...
var jvm = {
  ...
  values: function (t) {
    for (var e, a = [], s = 0; s < arguments.length; s++)
      for (e in (t = arguments[s])) a.push(t[e]);
    return a;
  },
...
(jvm.$ = jQuery),
  ...
  (jvm.AbstractElement.prototype.set = function (t, e) {
    if ("object" == typeof t)
      for (var a in t) (this.properties[a] = t[a]), this.applyAttr(a, t[a]);
  ...
  (jvm.AbstractCanvasElement.prototype.addPath = function (t, e, a) {
    return (
      (e = new jvm[this.classPrefix + "PathElement"](t, e)), this.add(e, a), e
    );
  }),
  (jvm.AbstractCanvasElement.prototype.addCircle = function (t, e, a) {
    return (
      (e = new jvm[this.classPrefix + "CircleElement"](t, e)), this.add(e, a), e
    );
  }),
  (jvm.AbstractCanvasElement.prototype.addImage = function (t, e, a) {
    return (
      (e = new jvm[this.classPrefix + "ImageElement"](t, e)), this.add(e, a), e
    );
  }),
  (jvm.AbstractCanvasElement.prototype.addText = function (t, e, a) {
    return (
      (e = new jvm[this.classPrefix + "TextElement"](t, e)), this.add(e, a), e
    );
  }),
  ...
  (jvm.VMLCircleElement.prototype.applyAttr = function (t, e) {
    switch (t) {
      case "r":
        ...
        break;
      case "cx":
        e && (this.node.style.left = e - (this.get("r") || 0) + "px");
        break;
      case "cy":
        e && (this.node.style.top = e - (this.get("r") || 0) + "px");
        break;
      default:
  ...
  (jvm.NumericScale.prototype = {
    ...
    vectorToNum: function (t) {
      for (var e = 0, a = 0; a < t.length; a++)
        e += Math.round(t[a]) * Math.pow(256, t.length - a - 1);
      return e;
    },
    ...
    getTicks: function () {
      ...
      for (
        ...
        (e =
          ...
          n.push({ label: t, value: this.getValue(e) }),
          (t += i);
      return n;
    },
  }),
  ...
  (jvm.ColorScale.arrayToRgb = function (t) {
    for (var e, a = "#", s = 0; s < t.length; s++)
      a += 1 == (e = t[s].toString(16)).length ? "0" + e : e;
    return a;
  }),
  ...
  (jvm.Legend = function (t) {
    (this.params = t || {}),
      ...
      (t.vertical
        ? this.map.legendCntVertical
        : this.map.legendCntHorizontal
      ).append(this.body),
      this.render();
  }),
      ...
      jvm.$.isArray(t.scale)
        ? ((a =
            "fill" === t.attribute || "stroke" === t.attribute
              ? jvm.ColorScale
              : jvm.NumericScale),
          (this.scale = new a(t.scale, t.normalizeFunction, t.min, t.max)))
        : t.scale
  ...
  (jvm.DataSeries.prototype = {
    ...
    clear: function () {
      ...
      for (t in this.values)
        this.elements[t] &&
          (e[t] =
            this.elements[t].element.shape.style.initial[
  ...
  (jvm.Proj = {
    ...
    aea: function (t, e, a) {
      ...
      return {
        x: t * Math.sin(s) * this.radius,
        y: -(a - t * Math.cos(s)) * this.radius,
      };
    },
    aea_inv: function (t, e, a) {
      var s = t / this.radius,
        ...
        i = Math.atan(s / (t - i));
      return {
        lat: Math.asin((a - r * r * e * e) / (2 * e)) * this.degRad,
        lng: (n + i / e) * this.degRad,
      };
    },
    lcc: function (t, e, a) {
      var s = a * this.radDeg,
        ...
        t = t * this.radDeg,
        e =
          Math.log(Math.cos(a) * (1 / Math.cos(e))) /
          Math.log(
            Math.tan(Math.PI / 4 + e / 2) * (1 / Math.tan(Math.PI / 4 + a / 2))
          ),
        t =
          (a = (Math.cos(a) * Math.pow(Math.tan(Math.PI / 4 + a / 2), e)) / e) *
          Math.pow(1 / Math.tan(Math.PI / 4 + t / 2), e),
        a = a * Math.pow(1 / Math.tan(Math.PI / 4 + 0), e);
      return {
        x: t * Math.sin(e * (i - s)) * this.radius,
        y: -(a - t * Math.cos(e * (i - s))) * this.radius,
      };
    },
    lcc_inv: function (t, e, a) {
      var s = t / this.radius,
        ...
        t = 45 * this.radDeg,
        e =
          Math.log(Math.cos(r) * (1 / Math.cos(t))) /
          Math.log(
            Math.tan(Math.PI / 4 + t / 2) * (1 / Math.tan(Math.PI / 4 + r / 2))
          ),
        t =
          (a = (Math.cos(r) * Math.pow(Math.tan(Math.PI / 4 + r / 2), e)) / e) *
          Math.pow(1 / Math.tan(Math.PI / 4 + 0), e),
        r = this.sgn(e) * Math.sqrt(s * s + (t - i) * (t - i)),
        i = Math.atan(s / (t - i));
      return {
        lat:
          (2 * Math.atan(Math.pow(a / r, 1 / e)) - Math.PI / 2) * this.degRad,
        lng: (n + i / e) * this.degRad,
      };
    },
  }),
  ...
  (jvm.MapObject.prototype.setHovered = function (t) {
    this.isHovered !== t &&
      ...
      this.label) &&
      ((this.label.isHovered = t), this.label.updateStyle());
  }),
  ...
  (jvm.Map.prototype = {
      ...
      this.params.panOnDrag &&
        (this.container
          .mousemove(function (t) {
            return (
              s &&
                ((h.transX -= (e - t.pageX) / h.scale),
                (h.transY -= (a - t.pageY) / h.scale),
                h.applyTransform(),
                (e = t.pageX),
                (a = t.pageY)),
              !1
        ...
        this.params.zoomOnScroll &&
          this.container.mousewheel(function (t, e, a, s) {
            var i = jvm.$(h.container).offset(),
              ...
              r = t.pageY - i.top,
              i = Math.pow(
                1 + h.params.zoomOnScrollSpeed / 1e3,
    ...
    bindContainerTouchEvents: function () {
      function t(t) {
        ...
        "touchstart" == t.type && (m = 0),
          1 == s.length
            ? (1 == m &&
                ((e = c.transX),
                (a = c.transY),
                (c.transX -= (r - s[0].pageX) / c.scale),
                (c.transY -= (h - s[0].pageY) / c.scale),
                c.applyTransform(),
                c.tip.hide(),
                (e == c.transX && a == c.transY) || t.preventDefault()),
              (r = s[0].pageX),
              (h = s[0].pageY))
            : 2 == s.length &&
              (2 == m
      ...
      this.container.mousemove(function () {
        ...
        this.container.delegate(
          ...
          function (t) {
            var e =
              ...
              i =
                "region" == e
                  ? h.mapData.paths[a].name
                  : h.markers[a].config.name || "",
              n = jvm.$.Event(e + "TipShow.jvectormap"),
              r = jvm.$.Event(e + "Over.jvectormap");
            "mouseover" == t.type
              ? (h.container.trigger(r, [a]),
                r.isDefaultPrevented() || s.setHovered(!0),
                h.tip.text(i),
                h.container.trigger(n, [h.tip, a]),
                n.isDefaultPrevented() ||
                  (h.tip.show(),
                  (h.tipWidth = h.tip.width()),
                  (h.tipHeight = h.tip.height())))
              : (s.setHovered(!1),
                h.tip.hide(),
                h.container.trigger(e + "Out.jvectormap", [a]));
          }
        ),
        this.container.delegate(
          "[class~='jvectormap-element']",
        ...
        this.container.delegate(
          ...
          function () {
            ...
            i ||
              (h.container.trigger(a, [e]),
              (("region" == t && h.params.regionsSelectable) ||
                ("marker" == t && h.params.markersSelectable)) &&
                !a.isDefaultPrevented() &&
                (h.params[t + "sSelectableOne"] && h.clearSelected(t + "s"),
    ...
    setSelected: function (t, e) {
      if (jvm.$.isArray((e = "object" != typeof e ? [e] : e)))
    ...
    clearSelected: function (t) {
      for (var e = {}, a = this.getSelected(t), s = 0; s < a.length; s++)
        e[a[s]] = !1;
    ...
    createMarkers: function (t) {
      ...
      if (
        ...
        for (i = t.slice(), t = {}, e = 0; e < i.length; e++) t[e] = i[e];
      for (e in t)
    ...
    latLngToPoint: function (t, e) {
      ...
      return (
        e < -180 + s && (e += 360),
        (t = jvm.Proj[a.type](t, e, s)),
        !!(e = this.getInsetForPoint(t.x, t.y)) &&
          ((s = e.bbox),
          (t.x = ((t.x - s[0].x) / (s[1].x - s[0].x)) * e.width * this.scale),
          (t.y = ((t.y - s[0].y) / (s[1].y - s[0].y)) * e.height * this.scale),
          {
            x: t.x + this.transX * this.scale + e.left * this.scale,
            y: t.y + this.transY * this.scale + e.top * this.scale,
          })
      );
    },
    pointToLatLng: function (t, e) {
      for (
        ...
        if (
          ((s = (a = o[l]).bbox),
          (i = t - (this.transX * this.scale + a.left * this.scale)),
          (n = e - (this.transY * this.scale + a.top * this.scale)),
          (i = (i / (a.width * this.scale)) * (s[1].x - s[0].x) + s[0].x),
          (n = (n / (a.height * this.scale)) * (s[1].y - s[0].y) + s[0].y),
          i > s[0].x && i < s[1].x && n > s[0].y && n < s[1].y)
        )
          return jvm.Proj[r.type + "_inv"](i, -n, h);
      return !1;
    },
    getInsetForPoint: function (t, e) {
      for (
        var a, s = jvm.Map.maps[this.params.map].insets, i = 0;
        i < s.length;
        i++
      )
        if (t > (a = s[i].bbox)[0].x && t < a[1].x && e > a[0].y && e < a[1].y)
          return s[i];
    },
