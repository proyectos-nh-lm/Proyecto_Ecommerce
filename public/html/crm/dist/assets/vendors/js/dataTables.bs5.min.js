!(function (t) {
  ...
  return (
    ...
    (o.ext.renderer.pageButton.bootstrap = function (d, e, l, a, c, u) {
      var p,
        f,
        t,
        b = new o.Api(d),
      ...
      n.length
        ...
        (function e(a, t) {
          for (
            ...
            if (((r = t[o]), Array.isArray(r))) e(a, r);
            else {
              switch (((f = p = ""), r)) {
                case "ellipsis":
                  (p = "&#x2026;"), (f = "disabled");
                  break;
                case "first":
                  (p = m.sFirst), (f = r + (0 < c ? "" : " disabled"));
                  break;
                case "previous":
                  (p = m.sPrevious), (f = r + (0 < c ? "" : " disabled"));
                  break;
                case "next":
                  (p = m.sNext), (f = r + (c < u - 1 ? "" : " disabled"));
                  break;
                case "last":
                  (p = m.sLast), (f = r + (c < u - 1 ? "" : " disabled"));
                  break;
                default:
                  (p = r + 1), (f = c === r ? "active" : "");
              }
              p &&
                ((n = x("<li>", {
                  ...
                  .appendTo(a)),
                d.oApi._fnBindAction(n, { action: r }, s));
            }
        })(n, a),
