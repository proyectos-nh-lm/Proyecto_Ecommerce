      ...
      [
        ...
        function (t, o, e) {
          ...
          function r(t, e) {
            ...
            return null != n && e & u.LEVEL & n.scope && e & u.TYPE & n.scope
              ? n
              : null;
          }
          var i,
          ...
          function s(t) {
            var e = this;
            return (
              ((e = l.call(this, (t = "[Parchment] " + t)) || this).message =
                t),
        ...
        function (t, e, n) {
          ...
          function s(t, e, n) {
            ...
            return void 0 !== o
              ? "value" in o
                ...
                ? o.call(n)
                : void 0
              : null === (t = Object.getPrototypeOf(t))
              ? void 0
              : s(t, e, n);
          }
          function u(t, e, n) {
          ...
          l(b, h.default.Embed),
            u(b, [
              {
                ...
                value: function () {
                  s(
                    ...
                    (this.attributes = new h.default.Attributor.Store(
                      this.domNode
                    ));
                },
              },
              {
                ...
                value: function () {
                  return new f.default().insert(
                    this.value(),
                    (0, c.default)(this.formats(), this.attributes.values())
                  );
                },
              },
              {
                ...
                value: function (t, e) {
                  null !=
                    (t = h.default.query(t, h.default.Scope.BLOCK_ATTRIBUTE)) &&
                    this.attributes.attribute(t, e);
                },
              },
              {
                key: "formatAt",
              ...
              },
              {
                ...
                value: function (t, e, n) {
                  ...
                  "string" == typeof e && e.endsWith("\n")
                    ? ((o = h.default.create(g.blotName)),
                      this.parent.insertBefore(o, 0 === t ? this : this.next),
                      o.insertAt(0, e.slice(0, -1)))
                    : s(
            ...
            ((n = b).scope = h.default.Scope.BLOCK_BLOT);
          l(m, h.default.Block),
            u(m, [
              {
                key: "delta",
              ...
              },
              {
                ...
                value: function (t, e, n, o) {
                  e <= 0 ||
                    (h.default.query(n, h.default.Scope.BLOCK)
                      ? t + e === this.length() && this.format(n, o)
                      : s(
                    ...
                    (0 < (e = (n = e.split("\n")).shift()).length &&
                      (t < this.length() - 1 || null == this.children.tail
                        ? s(
                            ...
                            "insertAt",
                            this
                          ).call(this, Math.min(t, this.length() - 1), e)
          ...
          function m(t) {
            return (
              ...
              ((t = i(
                this,
                (m.__proto__ || Object.getPrototypeOf(m)).call(this, t)
              )).cache = {}),
              t
            );
          }
          (g.blotName = "block"),
            ...
            (g.allowedChildren = [d.default, h.default.Embed, y.default]),
            (e.bubbleFormats = a),
            (e.BlockEmbed = n),
            (e.default = g);
        },
        function (t, e, n) {
          ...
          (s.prototype.insert = function (t, e) {
            ...
            (s.prototype.slice = function (t, e) {
              ...
              for (
                var n, o = [], r = f.iterator(this.ops), i = 0;
                i < e && r.hasNext();
            ...
            (s.prototype.compose = function (t) {
              for (
                ...
                "insert" === l.peekType()
                  ...
                  : "delete" === i.peekType()
                  ? a.push(i.next())
                  : ((r = Math.min(i.peekLength(), l.peekLength())),
                    (e = i.next(r)),
                    "number" == typeof (n = l.next(r)).retain
                      ? ((o = {}),
                        "number" == typeof e.retain
                          ? (o.retain = r)
                          : (o.insert = e.insert),
                        (r = f.attributes.compose(
                          e.attributes,
                          n.attributes,
                          "number" == typeof e.retain
                        )) && (o.attributes = r),
            ...
            (s.prototype.diff = function (n, t) {
              var e, i, l, a;
              return this.ops === n.ops
                ? new s()
                : ((e = [this, n].map(function (e) {
                    return e
                      .map(function (t) {
                        if (null != t.insert)
                      ...
                      switch (t[0]) {
                        ...
                        case u.EQUAL:
                          ...
                          c(o.insert, r.insert)
                            ? i.retain(
                                n,
                                f.attributes.diff(o.attributes, r.attributes)
                              )
                            : i.push(r).delete(n);
                      }
                      e -= n;
            ...
            (s.prototype.eachLine = function (t, e) {
              e = e || "\n";
              for (
                var n = f.iterator(this.ops), o = new s(), r = 0;
                n.hasNext();
                ...
                if (
                  ...
                  if ("insert" === o.peekType()) r.push(o.next());
                    ...
                    a.delete
                      ...
                      : r.retain(
                          i,
                          f.attributes.transform(l.attributes, a.attributes, e)
                        );
                  }
        ...
        function (t, e, n) {
          ...
          function s() {
            ...
            if (!(t instanceof s))
              throw new TypeError("Cannot call a class as a function");
            var t = this,
              e = (s.__proto__ || Object.getPrototypeOf(s)).apply(
                this,
                arguments
              );
            if (t)
          ...
          (n.prototype = Object.create(c && c.prototype, {
              ...
              [
                {
                  ...
                  value: function (t, e, n, o) {
                    var r;
                    s.compare(this.statics.blotName, n) < 0 &&
                    a.default.query(n, a.default.Scope.BLOT)
                      ? ((r = this.isolate(t, e)), o && r.wrap(n, o))
                      : i(
            ...
            ((r = s).allowedChildren = [r, a.default.Embed, l.default]),
            (r.order = [
              "cursor",
              "inline",
              "underline",
        ...
        function (t, e, n) {
          ...
          function a(t, e, n, o) {
            ...
            return this.options.strict &&
              !this.isEnabled() &&
              e === y.default.sources.USER
              ? new p.default()
              : ((r = null == n ? null : this.getSelection()),
                (i = this.editor.delta),
                (t = t()),
                null != r &&
                  (!0 === n && (n = r.index),
                  null == o ? (r = u(r, t, e)) : 0 !== o && (r = u(r, n, o, e)),
                  this.setSelection(r, y.default.sources.SILENT)),
                0 < t.length() &&
                  ((r = [y.default.events.TEXT_CHANGE, t, i, e]),
                  (i = this.emitter).emit.apply(
                    i,
                    [y.default.events.EDITOR_CHANGE].concat(r)
                  ),
                  e !== y.default.sources.SILENT) &&
                  (e = this.emitter).emit.apply(e, r),
                t);
          }
          function s(t, e, n, o, r) {
            ...
            return (
              "number" == typeof t.index && "number" == typeof t.length
                ? ("number" != typeof e && ((r = o), (o = n), (n = e)),
                  (e = t.length),
                  (t = t.index))
                : "number" != typeof e && ((r = o), (o = n), (n = e), (e = 0)),
              "object" === (void 0 === n ? "undefined" : f(n))
                ? ((i = n), (r = o))
                : "string" == typeof n && (null != o ? (i[n] = o) : (r = n)),
              [t, e, i, (r = r || y.default.sources.API)]
            );
          }
          function u(t, e, n, o) {
            var r, i;
              ...
              : ((r = void 0),
                (i = (
                  e instanceof p.default
                    ? ((i = [t.index, t.index + t.length].map(function (t) {
                        return e.transformPosition(
                          t,
                          o !== y.default.sources.USER
                        );
                      })),
                      (r = (i = c(i, 2))[0]),
                      i)
          ...
          function c(t, e) {
            ...
            if (Symbol.iterator in Object(t)) {
              ...
              try {
                for (
                  var l, a = n[Symbol.iterator]();
                  !(i = (l = a.next()).done) &&
                  (r.push(l.value), !o || r.length !== o);
                  i = !0
                );
              } catch (n) {
                (t = !0), (e = n);
              ...
              r(E, [
                      ...
                      function () {
                        ...
                        if (null != t) {
                          if (v.default.query(n, v.default.Scope.BLOCK))
                            ...
                            e = r.editor.formatText(
                              t.index,
                              t.length,
                              i({}, n, o)
                            );
                          }
                          r.setSelection(t, y.default.sources.SILENT);
                        }
                        return e;
                      },
                      t
                  ...
                  value: function (o) {
                    ...
                    return a.call(
                      ...
                      function () {
                        ...
                        return (
                          null != (t = n.ops[n.ops.length - 1]) &&
                            "string" == typeof t.insert &&
                            "\n" === t.insert[t.insert.length - 1] &&
                            (r.editor.deleteText(r.getLength() - 1, 1),
                            n.delete(1)),
                          e.compose(n)
                        );
                      },
                ...
                },
                {
                  ...
                  value: function (t, e, n) {
                    var o;
                    null == t
                      ? this.selection.setRange(null, e || E.sources.API)
                      : ((o = s(t, e, n)),
                        (t = (o = c(o, 4))[0]),
                        (e = o[1]),
                        (n = o[3]),
                        this.selection.setRange(new g.Range(t, e), n),
                        n !== y.default.sources.SILENT &&
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return a.call(
                      ...
                      function () {
                        return (
                          (t = new p.default(t)), e.editor.applyDelta(t, n)
                        );
                      },
                      n,
                      !0
          ...
          function E(t) {
            ...
            this.options.debug && E.debug(this.options.debug),
              ...
              ((this.container.__quill = this).root =
                this.addContainer("ql-editor")),
              ...
              this.emitter.on(y.default.events.EDITOR_CHANGE, function (t) {
                t === y.default.events.TEXT_CHANGE &&
        ...
        function (t, e, n) {
          ...
          function o() {
            ...
            if (!(t instanceof o))
              throw new TypeError("Cannot call a class as a function");
            var t = this,
              e = (o.__proto__ || Object.getPrototypeOf(o)).apply(
                this,
                arguments
              );
            if (t)
          ...
          Object.defineProperty(e, "__esModule", { value: !0 });
          var r = o,
            i = ((n = n(0)) && n.__esModule ? n : { default: n }).default.Text;
              ...
              document.addEventListener(t, function () {
                ...
                [].slice
                  ...
                  .forEach(function (t) {
                    t.__quill &&
                      t.__quill.emitter &&
                      (t = t.__quill.emitter).handleDOM.apply(t, e);
                  });
              });
            }
          );
              ...
              },
              {
                ...
                value: function (n) {
                  ...
                  (this.listeners[n.type] || []).forEach(function (t) {
                    var e = t.node,
                      t = t.handler;
                    (n.target !== e && !e.contains(n.target)) ||
        ...
        function (t, e, n) {
          ...
          var o = n(1),
            n =
              ...
              (r.prototype.canAdd = function (t, e) {
                return (
                  null !=
                    o.query(t, o.Scope.BLOT & (this.scope | o.Scope.TYPE)) &&
                  (null == this.whitelist ||
                    ("string" == typeof e
                      ? -1 < this.whitelist.indexOf(e.replace(/["']/g, ""))
                      : -1 < this.whitelist.indexOf(e)))
                );
              }),
          ...
          function r(t, e, n) {
            void 0 === n && (n = {}),
              (this.attrName = t),
              (this.keyName = e),
              (e = o.Scope.TYPE & o.Scope.ATTRIBUTE),
              null != n.scope
                ? (this.scope = (n.scope & o.Scope.LEVEL) | e)
        ...
        function (t, e, n) {
          ...
          function y() {
            return (
              ...
              i(
                this,
                (y.__proto__ || Object.getPrototypeOf(y)).apply(this, arguments)
              )
            );
          }
          function b(t, e) {
              ...
              [
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    (t === this.statics.blotName && e) ||
                      (null !=
                        (n = s(
                          (n = this.descendant(d.default, this.length() - 1)),
                          1
                        )[0]) && n.deleteAt(n.length() - 1, 1),
                      a(
                ...
                },
                {
                  ...
                  value: function (t, e, n, o) {
                    var r, i, l, a;
                    0 === e ||
                      null == f.default.query(n, f.default.Scope.BLOCK) ||
                      (n === this.statics.blotName &&
                        o === this.statics.formats(this.domNode)) ||
                      (a = this.newlineIndex(t)) < 0 ||
                      t + e <= a ||
                      ((i = a - (r = this.newlineIndex(t, !0) + 1) + 1),
                      (a = (l = this.isolate(r, i)).next),
                      l.format(n, o),
                      a instanceof v && a.formatAt(0, t - r + e - i, n, o));
                  },
                },
                {
                  key: "insertAt",
                  value: function (t, e, n) {
                    null == n &&
                      ((n = (t = s((n = this.descendant(d.default, t)), 2))[0]),
                      (t = t[1]),
                      n.insertAt(t, e));
                  },
                },
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return 1 < arguments.length &&
                      void 0 !== arguments[1] &&
                      arguments[1]
                      ? this.domNode.textContent.slice(0, t).lastIndexOf("\n")
                      : -1 <
                  ...
                  value: function (t) {
                    ...
                    null != e &&
                      ...
                      this.statics.formats(this.domNode) ===
                        e.statics.formats(e.domNode) &&
                      (e.optimize(t), e.moveChildren(this), e.remove());
                  },
                },
                {
                  key: "replace",
              ...
              [
                {
                  ...
                  value: function (t) {
                    return (
                      (t = a(
                        v.__proto__ || Object.getPrototypeOf(v),
                        "create",
                        this
                      ).call(this, t)).setAttribute("spellcheck", !1),
                      t
                    );
                  },
                },
        ...
        function (t, e, n) {
          ...
          function r() {
            ...
            if (!(t instanceof r))
              throw new TypeError("Cannot call a class as a function");
            var t = this,
              e = (r.__proto__ || Object.getPrototypeOf(r)).apply(
                this,
                arguments
              );
            if (t)
          ...
          var l = r,
            n = ((n = n(0)) && n.__esModule ? n : { default: n }).default.Embed;
        ...
        function (t, e, n) {
          ...
          function o(t, e) {
            ...
            return (
              (n.href = t),
              (n = n.href.slice(0, n.href.indexOf(":"))),
              -1 < e.indexOf(n)
            );
          }
          function r(t, e, n) {
          ...
          function l() {
            ...
            if (!(t instanceof l))
              throw new TypeError("Cannot call a class as a function");
            var t = this,
              e = (l.__proto__ || Object.getPrototypeOf(l)).apply(
                this,
                arguments
              );
            if (t)
          ...
          var s = l,
            n = ((n = n(5)) && n.__esModule ? n : { default: n }).default;
          if ("function" != typeof n && null !== n)
            throw new TypeError(
              "Super expression must either be null or a function, not " +
                typeof n
            ...
            i(
              ...
              [
                ...
                },
                {
                  key: "sanitize",
                  value: function (t) {
                    return o(t, this.PROTOCOL_WHITELIST)
                      ? t
                      : this.SANITIZED_URL;
                  },
                },
            ...
            r =
                  ...
                  [].slice
                    ...
                    .forEach(function (t) {
                      try {
                        ...
                        if (!(t instanceof u.ParchmentError)) throw t;
                      }
                    });
              }),
              ...
              (c.prototype.descendant = function (t, e) {
                var e = (n = this.children.find(e))[0],
                  n = n[1];
                return (null == t.blotName && t(e)) ||
                  (null != t.blotName && e instanceof t)
                  ? [e, n]
                  : e instanceof c
                  ? e.descendant(t, n)
                  : [null, -1];
              ...
              (c.prototype.descendants = function (o, t, e) {
                ...
                return (
                  this.children.forEachAt(t, e, function (t, e, n) {
                    ((null == o.blotName && o(t)) ||
                      (null != o.blotName && t instanceof o)) &&
                      r.push(t),
                      t instanceof c && (r = r.concat(t.descendants(o, e, i))),
                      (i -= n);
                  }),
                  r
                );
              ...
              (c.prototype.insertAt = function (t, e, n) {
                ...
                t
                  ? t.insertAt(o, e, n)
                  : ((n = null == n ? u.create("text", e) : u.create(e, n)),
                    this.appendChild(n));
              }),
              ...
              (c.prototype.optimize = function (t) {
                ...
                l.prototype.optimize.call(this, t),
                  0 === this.children.length &&
                    (null != this.statics.defaultChild
                      ? ((e = u.create(this.statics.defaultChild)),
                        this.appendChild(e),
                        e.optimize(t))
                      : this.remove());
              }),
              (c.prototype.path = function (t, e) {
                var n = (o = this.children.find(
                    t,
                    (e = void 0 === e ? !1 : e)
                  ))[0],
                  o = o[1],
              ...
              (c.prototype.replace = function (t) {
                t instanceof c && t.moveChildren(this),
                  ...
                  o
                    ...
                    .forEach(function (t) {
                      ...
                      null != t.nextSibling && (e = u.find(t.nextSibling)),
                        ((t = i(t)).next == e && null != t.next) ||
                          (null != t.parent && t.parent.removeChild(n),
                          n.insertBefore(t, e || void 0));
                    });
              }),
              c);
          function c(t) {
        ...
        function (t, e, n) {
          ...
          var i,
            ...
            r =
              ...
              (c.prototype.replaceWith = function (t, e) {
                return (
                  (e = i.prototype.replaceWith.call(this, t, e)),
              ...
              (c.prototype.wrap = function (t, e) {
                return (
                  (e = i.prototype.wrap.call(this, t, e)) instanceof c &&
          ...
          function c(t) {
            return (
              ((t = i.call(this, t) || this).attributes = new a.default(
                t.domNode
              )),
              t
            );
              ...
              attributes: {
                ...
                diff: function (n, o) {
                  ...
                  var t = Object.keys(n)
                    ...
                    .reduce(function (t, e) {
                      return (
                        r(n[e], o[e]) || (t[e] = void 0 === o[e] ? null : o[e]),
                        t
                      );
                    }, {});
          ...
          (o.prototype.hasNext = function () {
            ...
            (o.prototype.next = function (t) {
              ...
              return o
                ? ((e = this.offset),
                  (n = l.length(o)) - e <= t
                    ? ((t = n - e), (this.index += 1), (this.offset = 0))
                    : (this.offset += t),
                  "number" == typeof o.delete
                    ? { delete: t }
                    : ((n = {}),
                      o.attributes && (n.attributes = o.attributes),
                      "number" == typeof o.retain
                        ? (n.retain = t)
                        : "string" == typeof o.insert
                        ? (n.insert = o.insert.substr(e, t))
                        : (n.insert = o.insert),
                      n))
                : { retain: 1 / 0 };
            }),
              ...
              return (
                ...
                (function o(t, r) {
                  ...
                  if (m(t, w)) n = new w();
                    ...
                    (n = new RegExp(t.source, O(t))),
                      t.lastIndex && (n.lastIndex = t.lastIndex);
                  else if (_.__isDate(t)) n = new Date(t.getTime());
                  else {
                    if (g && Buffer.isBuffer(t))
                      return (n = new Buffer(t.length)), t.copy(n), n;
                    m(t, Error)
                      ? (n = Object.create(t))
                      : void 0 === d
                      ? ((e = Object.getPrototypeOf(t)), (n = Object.create(e)))
                      : ((n = Object.create(d)), (e = d));
                  }
                  if (p) {
                    var l = b.indexOf(t);
                    if (-1 != l) return v[l];
                  ...
                  t))
                    ((i = e ? Object.getOwnPropertyDescriptor(e, s) : i) &&
                      null == i.set) ||
                      (n[s] = o(t[s], r - 1));
                  if (Object.getOwnPropertySymbols)
                    for (
                      var a = Object.getOwnPropertySymbols(t), s = 0;
                      s < a.length;
                      s++
                    ) {
                      var u = a[s];
                      ((f = Object.getOwnPropertyDescriptor(t, u)) &&
                        !f.enumerable &&
                        !y) ||
                        ((n[u] = o(t[u], r - 1)), f.enumerable) ||
                        Object.defineProperty(n, u, { enumerable: !1 });
                    }
                  if (y)
                    for (
                      var c = Object.getOwnPropertyNames(t), s = 0;
                      s < c.length;
                      s++
                    ) {
                      var f,
                      ...
                      ((f = Object.getOwnPropertyDescriptor(t, h)) &&
                        f.enumerable) ||
                        ((n[h] = o(t[h], r - 1)),
                        Object.defineProperty(n, h, { enumerable: !1 }));
                    }
                  return n;
                })(t, (e = void 0 === e ? 1 / 0 : e))
              );
        ...
        function (t, e, n) {
          ...
          function a(t) {
            var e =
              1 < arguments.length && void 0 !== arguments[1]
                ? arguments[1]
                : 0;
            r(this, a), (this.index = t), (this.length = e);
          }
          var u = function (t, e, n) {
              return e && b(t.prototype, e), n && b(t, n), t;
            },
            ...
            h = o(n(12)),
            p = o(n(9)),
            d = (0, o(n(10)).default)("quill:selection"),
            u =
              (u(y, [
                {
                  ...
                  value: function () {
                    ...
                    this.emitter.listenDOM(
                      ...
                      this.emitter.listenDOM(
                        ...
                        document.body,
                        function () {
                          (t.mouseDown = !1), t.update(p.default.sources.USER);
                        }
                      );
                  },
                },
                    ...
                    if (
                      ...
                      if (
                        ...
                        if (n.start.node !== this.cursor.textNode) {
                          var o,
                            r = c.default.find(n.start.node, !1);
                          if (null == r) return;
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e,
                      ...
                      o =
                        ((t = Math.min(t, r - 1)), Math.min(t + o, r - 1) - t),
                      i = void 0,
                      l = s((a = this.scroll.leaf(t)), 2),
                      r = l[0],
                      a = l[1];
                    return null == r
                      ? null
                      : ((i = (l = s((l = r.position(a, !0)), 2))[0]),
                        (a = l[1]),
                        (l = document.createRange()),
                        0 < o
                          ? (l.setStart(i, a),
                            (r = (n = s((e = this.scroll.leaf(t + o)), 2))[0]),
                            (a = n[1]),
                            null == r
                              ? null
                              : ((i = (n = s((e = r.position(a, !0)), 2))[0]),
                                (a = n[1]),
                                l.setEnd(i, a),
                          ...
                          : ((e = "left"),
                            ...
                            i instanceof Text
                              ? (a < i.data.length
                                  ? (l.setStart(i, a), l.setEnd(i, a + 1))
                                  : (l.setStart(i, a - 1),
                                    l.setEnd(i, a),
                                    (e = "right")),
                                (n = l.getBoundingClientRect()))
                              : ((n = r.domNode.getBoundingClientRect()),
                                0 < a && (e = "right")),
                            {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return null == t ||
                      t.rangeCount <= 0 ||
                      null == (t = t.getRangeAt(0))
                      ? null
                      : ((t = this.normalizeNative(t)),
                        d.info("getNativeRange", t),
                        t);
                  },
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return (
                      ...
                      (t = e.map(function (t) {
                        var e = (o = s(t, 2))[0],
                          n = o[1],
                          o = (t = c.default.find(e, !0)).offset(r.scroll);
                        return 0 === n
                          ? o
                          : t instanceof c.default.Container
                          ? o + t.length()
                          : o + t.index(e, n);
                      })),
                      (e = Math.min(
                        Math.max.apply(Math, i(t)),
                ...
                },
                {
                  key: "normalizeNative",
                  value: function (t) {
                    return l(this.root, t.startContainer) &&
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return (
                      t.forEach(function (t, e) {
                        t = Math.min(i - 1, t);
                        var n = (t = s((n = o.scroll.leaf(t)), 2))[0],
                          t = t[1],
                          n = (e = s((e = n.position(t, 0 !== e)), 2))[0],
                          t = e[1];
                        r.push(n, t);
                      }),
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e,
                      ...
                      i = this.lastRange;
                    null != i &&
                      null != (e = this.getBounds(i.index, i.length)) &&
                      ((o = this.scroll.length() - 1),
                      (r = n =
                        s((r = this.scroll.line(Math.min(i.index, o))), 1)[0]),
                      0 < i.length &&
                        (r = s(
                          this.scroll.line(Math.min(i.index + i.length, o)),
                          1
                        )[0]),
                      null != n) &&
                      null != r &&
                  ...
                  value: function (t, e) {
                    var n,
                      ...
                      l =
                        ...
                        void 0 !== arguments[4] &&
                        arguments[4];
                    d.info("setNativeRange", t, e, r, i),
                      (null == t ||
                        (null != this.root.parentNode &&
                          null != t.parentNode &&
                          null != r.parentNode)) &&
                        null != (n = document.getSelection()) &&
                        (null != t
                          ? (this.hasFocus() || this.root.focus(),
                            (null !=
                              (o = (this.getNativeRange() || {}).native) &&
                              !l &&
                              t === o.startContainer &&
                              e === o.startOffset &&
                              r === o.endContainer &&
                              ...
                              "BR" == r.tagName &&
                                ((i = [].indexOf.call(
                                  r.parentNode.childNodes,
                                  r
                                )),
                                (r = r.parentNode)),
                              (o = document.createRange()).setStart(t, e),
                              o.setEnd(r, i),
                              n.removeAllRanges(),
                              n.addRange(o)))
                          : (n.removeAllRanges(),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    "string" == typeof e && ((n = e), (e = !1)),
                      d.info("setRange", t),
                      null != t
                        ? ((t = this.rangeToNative(t)),
                          this.setNativeRange.apply(this, i(t).concat([e])))
                    ...
                    (this.lastRange = n),
                      ...
                      (0, h.default)(e, this.lastRange) ||
                        (!this.composing &&
                          null != o &&
                          o.native.collapsed &&
                          o.start.node !== this.cursor.textNode &&
                          this.cursor.restore(),
                        (o = [
                        ...
                        (e = this.emitter).emit.apply(
                          e,
                          [p.default.events.EDITOR_CHANGE].concat(o)
                        ),
                        t !== p.default.sources.SILENT &&
                          (t = this.emitter).emit.apply(t, o));
                  },
                },
              ]),
              y);
          function y(t, e) {
            ...
            r(this, y),
              ...
              (this.lastRange = this.savedRange = new a(0, 0)),
              this.handleComposition(),
              this.handleDragging(),
              this.emitter.listenDOM("selectionchange", document, function () {
                i.mouseDown ||
                  setTimeout(i.update.bind(i, p.default.sources.USER), 1);
              }),
              this.emitter.on(p.default.events.EDITOR_CHANGE, function (t, e) {
                t === p.default.events.TEXT_CHANGE &&
                  0 < e.length() &&
                  i.update(p.default.sources.SILENT);
              }),
              this.emitter.on(
                p.default.events.SCROLL_BEFORE_UPDATE,
                function () {
                  var t;
                  i.hasFocus() &&
                    null != (t = i.getNativeRange()) &&
                    t.start.node !== i.cursor.textNode &&
                    i.emitter.once(p.default.events.SCROLL_UPDATE, function () {
                      try {
                        i.setNativeRange(
                          t.start.node,
                          t.start.offset,
              ...
              this.emitter.on(
                p.default.events.SCROLL_OPTIMIZE,
                function (t, e) {
                  var n, o, r;
                  e.range &&
                    ((n = (r = e.range).startNode),
                    (o = r.startOffset),
                    (e = r.endNode),
                    (r = r.endOffset),
                    i.setNativeRange(n, o, e, r));
                }
              ),
          ...
          (a.prototype = Object.create(s && s.prototype, {
            ...
            s &&
              (Object.setPrototypeOf
                ...
                : (a.__proto__ = s)),
            ((r = l).allowedChildren = [n.default, i.BlockEmbed, r]),
            (e.default = r);
        },
        function (t, e, n) {
          "use strict";
          ...
          var o = function (t, e, n) {
            ...
            r =
              ((function (t, e) {
                ...
                i,
                (n = (r = n(0)) && r.__esModule ? r : { default: r }).default
                  .Attributor.Style
              ),
              o(i, [
                {
                  ...
                  value: function (t) {
                    return (t = (function t(e, n, o) {
                      ...
                      "value",
                      this
                    ).call(this, t)).startsWith("rgb(")
                      ? "#" +
                          (t = t.replace(/^[^\d]+/, "").replace(/[^\d]+$/, ""))
                            .split(",")
                            .map(function (t) {
                              return ("00" + parseInt(t).toString(16)).slice(
                                -2
                              );
                            })
                            .join("")
              ...
              i),
            o = new n.default.Attributor.Class("color", "ql-color", {
          ...
          function i() {
            ...
            if (!(t instanceof i))
              throw new TypeError("Cannot call a class as a function");
            var t = this,
              e = (i.__proto__ || Object.getPrototypeOf(i)).apply(
                this,
                arguments
              );
            if (t)
        ...
        function (t, e, n) {
          ...
          function i(n, o) {
            ...
            return (
              ...
              r(e, "handler", function (t) {
                var e = t.index;
                return (
                  n === N.keys.RIGHT && (e += t.length + 1),
                  (e = this.quill.getLeaf(e)),
                  !(
                    y(e, 1)[0] instanceof O.default.Embed &&
                    (n === N.keys.LEFT
                      ? o
          ...
          function l(t, e) {
            ...
            0 === t.index ||
              ...
              ((n = this.quill.getLine(t.index)),
              (o = y(n, 1)[0]),
              (r = {}),
              0 === e.offset &&
                ((n = this.quill.getLine(t.index - 1)),
                null != (n = y(n, 1)[0])) &&
                1 < n.length() &&
                ((n = o.formats()),
                (o = this.quill.getFormat(t.index - 1, 1)),
                (r = _.default.attributes.diff(n, o) || {})),
              (e = /[\uD800-\uDBFF][\uDC00-\uDFFF]$/.test(e.prefix) ? 2 : 1),
              this.quill.deleteText(t.index - e, e, w.default.sources.USER),
          ...
          function a(t, e) {
            var n,
              ...
              i,
              l = /^[\uD800-\uDBFF][\uDC00-\uDFFF]/.test(e.suffix) ? 2 : 1;
            t.index >= this.quill.getLength() - l ||
              ((r = {}),
              (i = 0),
              (n = this.quill.getLine(t.index)),
              (o = y(n, 1)[0]),
              e.offset >= o.length() - 1 &&
                ((n = this.quill.getLine(t.index + 1)), (e = y(n, 1)[0])) &&
                ((n = o.formats()),
                (o = this.quill.getFormat(t.index, 1)),
                (r = _.default.attributes.diff(n, o) || {}),
                (i = e.length())),
              this.quill.deleteText(t.index, l, w.default.sources.USER),
              0 < Object.keys(r).length &&
                this.quill.formatLine(
                  t.index + i - 1,
                  l,
          ...
          function s(t) {
            ...
            1 < n.length &&
              ((e = n[0].formats()),
              (n = n[n.length - 1].formats()),
              (o = _.default.attributes.diff(n, e) || {})),
              this.quill.deleteText(t, w.default.sources.USER),
              0 < Object.keys(o).length &&
                this.quill.formatLine(t.index, 1, o, w.default.sources.USER),
              this.quill.setSelection(t.index, w.default.sources.SILENT),
              this.quill.focus();
          }
          function u(t, n) {
            var e = this,
              o =
                ...
                Object.keys(n.format).reduce(function (t, e) {
                  return (
                    O.default.query(e, O.default.Scope.BLOCK) &&
                      !Array.isArray(n.format[e]) &&
                      (t[e] = n.format[e]),
                    t
                  );
                }, {}));
            this.quill.insertText(t.index, "\n", o, w.default.sources.USER),
              ...
              Object.keys(n.format).forEach(function (t) {
                null != o[t] ||
                  Array.isArray(n.format[t]) ||
                  ("link" !== t &&
                    e.quill.format(t, n.format[t], w.default.sources.USER));
              });
          }
          function c(s) {
            return {
              ...
              handler: function (t) {
                ...
                null != l &&
                  ...
                  t.forEach(function (t, e) {
                    s
                      ? (l.insertAt(n + a, o.TAB),
                        (a += o.TAB.length),
                        0 === e ? (r += o.TAB.length) : (i += o.TAB.length))
                      : t.startsWith(o.TAB) &&
                        (l.deleteAt(n + a, o.TAB.length),
                        (a -= o.TAB.length),
                        0 === e ? (r -= o.TAB.length) : (i -= o.TAB.length)),
                      (a += t.length + 1);
                  }),
          ...
          function h(t) {
            ...
            if (
              ...
              if (null != N.keys[t.key.toUpperCase()])
                t.key = N.keys[t.key.toUpperCase()];
              else {
              ...
              p(j, [
                {
                  ...
                  value: function (t) {
                    ...
                    (t = (0, g.default)(
                      t,
                      (e = "function" == typeof e ? { handler: e } : e),
                      (n = "function" == typeof n ? { handler: n } : n)
                    )),
                      (this.bindings[t.key] = this.bindings[t.key] || []),
                      this.bindings[t.key].push(t);
                  },
                },
                {
                  key: "listen",
                      ...
                      e.defaultPrevented ||
                        ...
                        (null != (n = c.quill.getSelection()) &&
                          ...
                          (l =
                            0 === n.length
                              ? [i, a]
                              : c.quill.getLeaf(n.index + n.length)),
                          (l = (s = y(l, 2))[0]),
                          (s = s[1]),
                          (a =
                            i instanceof O.default.Text
                              ? i.value().slice(0, a)
                              : ""),
                          (s =
                            l instanceof O.default.Text
                              ? l.value().slice(s)
                              : ""),
                          (u = {
                            collapsed: 0 === n.length,
                            empty: 0 === n.length && o.length() <= 1,
                            format: c.quill.getFormat(n),
                            offset: r,
                            prefix: a,
                            suffix: s,
                          }),
                          t.some(function (e) {
                            if (
                              null != e.collapsed &&
                              e.collapsed !== u.collapsed
                            )
                              return !1;
                            if (null != e.empty && e.empty !== u.empty)
                              return !1;
                            if (null != e.offset && e.offset !== u.offset)
                              return !1;
                            if (Array.isArray(e.format)) {
                              ...
                              !Object.keys(e.format).every(function (t) {
                                return !0 === e.format[t]
                                  ...
                                  : !1 === e.format[t]
                                  ? null == u.format[t]
                                  : (0, v.default)(e.format[t], u.format[t]);
                              })
                            )
                              return !1;
                            return !(
                              (null != e.prefix && !e.prefix.test(u.prefix)) ||
                              (null != e.suffix && !e.suffix.test(u.suffix)) ||
                              !0 === e.handler.call(c, n, u)
                            );
                          })) &&
                          e.preventDefault());
                    });
            ...
            if (this instanceof j)
              return (
                ((n = (function (t, e) {
                  ...
                  this,
                  (j.__proto__ || Object.getPrototypeOf(j)).call(this, e, t)
                )).bindings = {}),
                Object.keys(n.options.bindings).forEach(function (t) {
                  ("list autofill" !== t ||
                    null == e.scroll.whitelist ||
                    e.scroll.whitelist.list) &&
                    n.options.bindings[t] &&
                    n.addBinding(n.options.bindings[t]);
                }),
                ...
                /Firefox/i.test(navigator.userAgent)
                  ? (n.addBinding(
                    ...
                    n.addBinding({ key: j.keys.DELETE }, { collapsed: !0 }, a))
                  : (n.addBinding(
                      { key: j.keys.BACKSPACE },
                      { collapsed: !0, prefix: /^.?$/ },
                      l
              ...
              bindings: {
                ...
                "outdent backspace": {
                  ...
                  handler: function (t, e) {
                    null != e.format.indent
                      ...
                      : null != e.format.list &&
                        this.quill.format("list", !1, w.default.sources.USER);
                  },
                },
                ...
                tab: {
                  ...
                  handler: function (t) {
                    ...
                    var e = new m.default()
                      ...
                      .delete(t.length)
                      .insert("\t");
                    this.quill.updateContents(e, w.default.sources.USER),
                      this.quill.history.cutoff(),
                      this.quill.setSelection(
                        t.index + 1,
                ...
                "header enter": {
                  ...
                  handler: function (t, e) {
                    ...
                    this.quill.updateContents(o, w.default.sources.USER),
                      this.quill.setSelection(
                        t.index + 1,
                        w.default.sources.SILENT
                      ),
          ...
          var r = n(1),
            n =
              ...
              (o.create = function (t) {
                ...
                return (
                  (t = Array.isArray(this.tagName)
                    ? "number" ==
                      typeof (t =
                        "string" == typeof t &&
                        ((t = t.toUpperCase()), parseInt(t).toString() === t)
                          ? parseInt(t)
                          : t)
                      ? document.createElement(this.tagName[t - 1])
                      : -1 < this.tagName.indexOf(t)
              ...
              (o.prototype.formatAt = function (t, e, n, o) {
                (t = this.isolate(t, e)),
                  null != r.query(n, r.Scope.BLOT) && o
                    ? t.wrap(n, o)
                    : null != r.query(n, r.Scope.ATTRIBUTE) &&
                      ((e = r.create(this.statics.scope)),
                      t.wrap(e),
                      e.format(n, o));
              }),
              (o.prototype.insertAt = function (t, e, n) {
                (n = null == n ? r.create("text", e) : r.create(e, n)),
                  (t = this.split(t)),
              ...
              (o.prototype.replaceWith = function (t, e) {
                return (
                  (t = "string" == typeof t ? r.create(t, e) : t).replace(this),
                  t
                );
              }),
              ...
              (o.prototype.wrap = function (t, e) {
                return (
                  (t = "string" == typeof t ? r.create(t, e) : t),
                  null != this.parent && this.parent.insertBefore(t, this.next),
                  t.appendChild(this),
                  t
                );
              }),
          ...
          var r = n(11),
            ...
            n =
              ...
              (o.prototype.build = function () {
                var e = this,
                  t = ((this.attributes = {}), r.default.keys(this.domNode)),
                  n = i.default.keys(this.domNode),
                  o = l.default.keys(this.domNode);
                t.concat(n)
                  .concat(o)
                  .forEach(function (t) {
                    (t = a.query(t, a.Scope.ATTRIBUTE)) instanceof r.default &&
                      (e.attributes[t.attrName] = t);
                  });
              }),
        ...
        function (t, e, n) {
          ...
          var l,
            ...
            i =
              ...
              (a.prototype.add = function (t, e) {
                return (
                  !!this.canAdd(t, e) && ((t.style[o(this.keyName)] = e), !0)
                );
              }),
            ...
            i(s, [
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  for (
                    var n = this, o = 0;
                    null != n && n.statics.scope !== l.default.Scope.BLOCK_BLOT;

                  )
                    (o += n.offset(n.parent)), (n = n.parent);
                  null != n &&
                    ((this._length = s.CONTENTS.length),
                    n.optimize(),
                    n.formatAt(o, s.CONTENTS.length, t, e),
                    (this._length = 0));
                },
              },
              {
                ...
                value: function () {
                  if (!this.selection.composing && null != this.parent) {
                    ...
                    for (
                      ...
                      n.start.node === e &&
                      n.end.node === e &&
                      ((n = [e, n.start.offset, n.end.offset]),
                      (o = n[0]),
                      (r = n[1]),
                      (i = n[2]));
                    ...
                    if (
                      (this.textNode.data !== s.CONTENTS &&
                        ((t = this.textNode.data.split(s.CONTENTS).join("")),
                        this.next instanceof a.default
                          ? ((o = this.next.domNode),
                            this.next.insertAt(0, t),
                            (this.textNode.data = s.CONTENTS))
                          : ((this.textNode.data = t),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return (
                      t === this.leftGuard
                        ? (n =
                            this.prev instanceof l.default
                              ? ((e = this.prev.length()),
                              ...
                              : ((o = document.createTextNode(r)),
                                ...
                                { startNode: o, startOffset: r.length }))
                        : t === this.rightGuard &&
                          (n =
                  ...
                  value: function (t, e) {
                    ...
                    t.forEach(function (t) {
                      "characterData" !== t.type ||
                        ...
                        ((t = n.restore(t.target)) && (e.range = t));
                    });
                  },
                },
              ]),
        ...
        function (t, e, n) {
          ...
          var o = (r = n(0)) && r.__esModule ? r : { default: r },
            r = n(24),
            n = new o.default.Attributor.Class("background", "ql-bg", {
              scope: o.default.Scope.INLINE,
            }),
            o = new r.ColorAttributor("background", "background-color", {
              scope: o.default.Scope.INLINE,
            });
        ...
        function (t, e, n) {
          ...
          var o = (r = n(0)) && r.__esModule ? r : { default: r },
            ...
            r = new o.default.Attributor.Class("font", "ql-font", n),
            n =
              ((function (t, e) {
                if ("function" != typeof e && null !== e)
                  throw new TypeError(
        ...
        function (t, e, n) {
          ...
          var o = new (n =
              (o = n(0)) && o.__esModule
                ? o
                : { default: o }).default.Attributor.Class("size", "ql-size", {
              scope: n.default.Scope.INLINE,
              whitelist: ["small", "large", "huge"],
            }),
            n = new n.default.Attributor.Style("size", "font-size", {
              scope: n.default.Scope.INLINE,
          ...
          function i(t, e) {
            if (this instanceof i)
              return (
                ...
                [].slice
                  .call(t.container.querySelectorAll(".ql-picker-item"), 0, 7)
                  .forEach(function (t) {
          ...
          function r(t, e) {
            if (this instanceof r)
              return (
                ...
                [].forEach.call(
                  t.container.querySelectorAll(".ql-picker-item"),
                  function (t) {
        ...
        function (t, e, n) {
          ...
          function x(n, t) {
            ...
            var o = i(
                this,
                (x.__proto__ || Object.getPrototypeOf(x)).call(this, n, t)
              ),
              t = function t(e) {
                if (!document.body.contains(n.root))
                  return document.body.removeEventListener("click", t);
                null == o.tooltip ||
                  o.tooltip.root.contains(e.target) ||
                  document.activeElement === o.tooltip.textbox ||
                  o.quill.hasFocus() ||
                  o.tooltip.hide(),
                  null != o.pickers &&
          ...
          function E(t, e) {
            return (
              ...
              ((e = i(
                this,
                (E.__proto__ || Object.getPrototypeOf(E)).call(this, t, e)
              )).textbox = e.root.querySelector('input[type="text"]')),
              e.listen(),
              e
            );
          }
          l(x, p.default),
                  ...
                  t.forEach(function (n) {
                    (n.getAttribute("class") || "")
                      ...
                      .forEach(function (t) {
                        var e;
                        t.startsWith("ql-") &&
                          ((t = t.slice("ql-".length)), null != o[t]) &&
                          ("direction" === t
                            ? (n.innerHTML = o[t][""] + o[t].rtl)
                            : "string" == typeof o[t]
                            ? (n.innerHTML = o[t])
                            : null != (e = n.value || "") &&
                              o[t][e] &&
              ...
              },
              {
                ...
                value: function (t, n) {
                  ...
                  (this.pickers = t.map(function (t) {
                    var e;
                    return t.classList.contains("ql-align")
                      ? (null == t.querySelector("option") && a(t, g),
                        new y.default(t, n.align))
                      : t.classList.contains("ql-background") ||
                        t.classList.contains("ql-color")
                      ? ((e = t.classList.contains("ql-background")
                          ? "background"
                          : "color"),
                        null == t.querySelector("option") &&
                          a(t, m, "background" == e ? "#ffffff" : "#000000"),
                        new d.default(t, n[e]))
                      : (null == t.querySelector("option") &&
            ...
            ((n = x).DEFAULTS = (0, u.default)(!0, {}, p.default.DEFAULTS, {
              modules: {
                toolbar: {
                  handlers: {
                    formula: function () {
            ...
            s(E, [
              {
                ...
                value: function () {
                  ...
                  this.textbox.addEventListener("keydown", function (t) {
                    h.default.match(t, "enter")
                      ? (e.save(), t.preventDefault())
                      : h.default.match(t, "escape") &&
                  ...
                  switch (this.root.getAttribute("data-mode")) {
                    case "link":
                      ...
                      this.linkRange
                        ...
                        : (this.restoreFocus(),
                          this.quill.format("link", e, f.default.sources.USER)),
                    ...
                    case "formula":
                      e &&
                        null != (t = this.quill.getSelection(!0)) &&
                        ((t = t.index + t.length),
                        ...
                        this.quill.setSelection(t + 2, f.default.sources.USER));
                  }
        ...
        function (t, e, n) {
          ...
          Object.defineProperty(e, "__esModule", { value: !0 }),
            ...
            (o.prototype.insertBefore = function (t, e) {
              t &&
                (null != (t.next = e)
                  ? ((t.prev = e.prev),
                  ...
                  : null != this.tail
                  ? (((this.tail.next = t).prev = this.tail), (this.tail = t))
            ...
            (o.prototype.find = function (t, e) {
              ...
              for (var n, o = this.iterator(); (n = o()); ) {
                ...
                if (
                  t < r ||
                  (e && t === r && (null == n.next || 0 !== n.next.length()))
                )
                  return [n, t];
                t -= r;
              }
            ...
            (o.prototype.forEachAt = function (t, e, n) {
              if (!(e <= 0))
                for (
                  var o,
                    r = this.find(t),
                  ...
                  var s = o.length();
                  l < t
                    ? n(o, t - l, Math.min(e, l + s - t))
                    : n(o, 0, Math.min(s, t + e - l)),
                    (l += s);
                }
            }),
                  ...
                  var r = function (t, e) {
                      void 0 === e && (e = !0),
                        null != t &&
                          t !== n &&
                          null != t.domNode.parentNode &&
                          (null == t.domNode[c.DATA_KEY].mutations &&
                            (t.domNode[c.DATA_KEY].mutations = []),
                          e) &&
                          r(t.parent);
                    },
                    i = function (t) {
                      null != t.domNode[c.DATA_KEY] &&
                        null != t.domNode[c.DATA_KEY].mutations &&
                        (t instanceof u.default && t.children.forEach(i),
                        t.optimize(e));
                    },
                    l = t,
                    a = 0;
                ...
                void 0 === e && (e = {}),
                  (t = t || this.observer.takeRecords())
                    .map(function (t) {
                      ...
                      return null == e
                        ? null
                        : null == e.domNode[c.DATA_KEY].mutations
                        ? ((e.domNode[c.DATA_KEY].mutations = [t]), e)
                        : (e.domNode[c.DATA_KEY].mutations.push(t), null);
                    })
                    .forEach(function (t) {
                      null != t &&
                        t !== n &&
                        null != t.domNode[c.DATA_KEY] &&
                        t.update(t.domNode[c.DATA_KEY].mutations || [], e);
                    }),
                  null != this.domNode[c.DATA_KEY].mutations &&
                    s.prototype.update.call(
                      this,
                      this.domNode[c.DATA_KEY].mutations,
                      e
                    ),
                  this.optimize(t, e);
              }),
            ...
            r =
              ...
              (s.prototype.format = function (t, e) {
                ...
                t !== this.statics.blotName || e
                  ...
                  : (this.children.forEach(function (t) {
                      t instanceof l.default || (t = t.wrap(s.blotName, !0)),
                        n.attributes.copy(t);
                    }),
                    this.unwrap());
              }),
              (s.prototype.formatAt = function (t, e, n, o) {
                null != this.formats()[n] || a.query(n, a.Scope.ATTRIBUTE)
                  ? this.isolate(t, e).format(n, o)
                  : i.prototype.formatAt.call(this, t, e, n, o);
              }),
          ...
          var i,
            ...
            r =
              ...
              (s.prototype.insertAt = function (t, e, n) {
                null == n || null != a.query(e, a.Scope.INLINE)
                  ? i.prototype.insertAt.call(this, t, e, n)
                  : ((t = this.split(t)),
                    (n = a.create(e, n)),
        ...
        function (t, e, n) {
          ...
          var i,
            ...
            r =
              ...
              (s.prototype.split = function (t, e) {
                ...
                return (
                  (t = a.create(this.domNode.splitText(t))),
          ...
          function s(t) {
            return (
              ((t = i.call(this, t) || this).text = t.statics.value(t.domNode)),
              t
            );
          }
          e.default = r;
          ...
          r.classList.toggle("test-class", !1),
            r.classList.contains("test-class") &&
              ...
              (DOMTokenList.prototype.toggle = function (t, e) {
                return 1 < arguments.length && !this.contains(t) == !e
                  ? e
                  : o.call(this, t);
              })),
              ...
              Object.defineProperty(Array.prototype, "find", {
                value: function (t) {
                  ...
                  for (
                    ...
                    if (((e = n[i]), t.call(r, e, i, n))) return e;
                },
              }),
        ...
        function (t, e) {
          function F(t, e, n) {
            ...
            var o = K(t, e),
              r = t.substring(0, o),
              o = z((t = t.substring(o)), (e = e.substring(o))),
              ...
              e = (function (t, e) {
                ...
                if (-1 != (n = r.indexOf(i)))
                  return (
                    (o = [
                      [V, r.substring(0, n)],
                      [W, i],
                      [V, r.substring(n + i.length)],
                    ]),
                    t.length > e.length && (o[0][0] = o[2][0] = Z),
                    o
                  );
                if (1 == i.length)
                  return [
                ...
                if (
                  ((a = e),
                  (p = (l = t).length > a.length ? l : a),
                  (d = l.length > a.length ? a : l),
                  (d =
                    !(p.length < 4 || 2 * d.length < p.length) &&
                    ((h = U(p, d, Math.ceil(p.length / 4))),
                    (p = U(p, d, Math.ceil(p.length / 2))),
                    h || p)
                      ? ((p = !p || (h && h[4].length > p[4].length) ? h : p),
                        l.length > a.length
                          ? ((s = p[0]), (u = p[1]), (c = p[2]), (f = p[3]))
                          : ((c = p[0]), (f = p[1]), (s = p[2]), (u = p[3])),
                        [s, u, c, f, p[4]])
                      : null))
                )
                  return (
                ...
                function U(t, e, n) {
                  for (
                    ...
                    var c = K(t.substring(n), e.substring(s)),
                      f = z(t.substring(0, n), e.substring(0, s));
                    u.length < f + c &&
                      ((u = e.substring(s - f, s) + e.substring(s, s + c)),
                      (o = t.substring(0, n - f)),
                      (r = t.substring(n + c)),
                      (i = e.substring(0, s - f)),
                      (l = e.substring(s + c)));
                      ...
                      case W:
                        1 < r + i
                          ? (0 !== r &&
                              0 !== i &&
                              (0 !== (n = K(a, l)) &&
                                (0 < o - r - i && e[o - r - i - 1][0] == W
                                  ? (e[o - r - i - 1][1] += a.substring(0, n))
                                  : (e.splice(0, 0, [W, a.substring(0, n)]),
                                    o++),
                                (a = a.substring(n)),
                                (l = l.substring(n))),
                              0 !== (n = z(a, l))) &&
                              ((e[o][1] = a.substring(a.length - n) + e[o][1]),
                              (a = a.substring(0, a.length - n)),
                              (l = l.substring(0, l.length - n))),
                            0 === r
                              ? e.splice(o - i, r + i, [V, a])
                              : 0 === i
                              ? e.splice(o - r, r + i, [Z, l])
                              : e.splice(o - r - i, r + i, [Z, l], [V, a]),
                            (o = o - r - i + (r ? 1 : 0) + (i ? 1 : 0) + 1))
                          : 0 !== o && e[o - 1][0] == W
                    ...
                    e[o - 1][0] == W &&
                      ...
                      e[o - 1][1]
                        ? ((e[o][1] =
                            ...
                            e[o][1].substring(
                              0,
                              e[o][1].length - e[o - 1][1].length
                            )),
                          (e[o + 1][1] = e[o - 1][1] + e[o + 1][1]),
                          e.splice(o - 1, 1),
                          (s = !0))
                        : e[o][1].substring(0, e[o + 1][1].length) ==
                            e[o + 1][1] &&
                          ((e[o - 1][1] += e[o + 1][1]),
                          (e[o][1] =
                            e[o][1].substring(e[o + 1][1].length) +
                            e[o + 1][1]),
                          e.splice(o + 1, 1),
                          (s = !0))),
                      o++;
                ...
                (e =
                  null != n
                    ? ((o = (i = (r = (function (t, e) {
                      ...
                      null == o || o[0] !== W
                        ? t
                        : null != r && o[1] + r[1] === r[1] + o[1]
                        ? (i.splice(n, 2, r, o), h(i, n, 2))
                        : null == r || 0 !== r[1].indexOf(o[1])
                        ? t
                        : (i.splice(n, 2, [r[0], o[1]], [0, o[1]]),
                          0 < (o = r[1].slice(o[1].length)).length &&
                            i.splice(n + 2, 0, [r[0], o]),
                          h(i, n, 3)))
                    : e));
            function a(t) {
              return 56320 <= t.charCodeAt(0) && t.charCodeAt(0) <= 57343;
            }
            for (var s, u = !1, c = 2; c < l.length; c += 1)
              l[c - 2][0] === W &&
                55296 <= (s = l[c - 2][1]).charCodeAt(s.length - 1) &&
                s.charCodeAt(s.length - 1) <= 56319 &&
                l[c - 1][0] === Z &&
                a(l[c - 1][1]) &&
                l[c][0] === V &&
                a(l[c][1]) &&
                ((u = !0),
                (l[c - 1][1] = l[c - 2][1].slice(-1) + l[c - 1][1]),
                (l[c][1] = l[c - 2][1].slice(-1) + l[c][1]),
                (l[c - 2][1] = l[c - 2][1].slice(0, -1)));
            if (!u) return l;
            for (var f = [], c = 0; c < l.length; c += 1)
              0 < l[c][1].length && f.push(l[c]);
            return f;
          }
          function H(t, e, n, o) {
          ...
          function K(t, e) {
            ...
            for (
              var n = 0, o = Math.min(t.length, e.length), r = o, i = 0;
              n < r;
          ...
          function z(t, e) {
            ...
            for (
              ...
              t.substring(t.length - r, t.length - i) ==
              e.substring(e.length - r, e.length - i)
                ? (i = n = r)
                : (o = r),
                (r = Math.floor((o - n) / 2 + n));
            return r;
          ...
          function h(t, e, n) {
            for (var o, r, i = e + n - 1; 0 <= i && e - 1 <= i; i--)
              i + 1 < t.length &&
                ((o = t[i]), (r = t[i + 1]), o[0] === r[1]) &&
                t.splice(i, 2, [o[0], o[1] + r[1]]);
            return t;
          }
          var Z = -1,
            V = 1,
            W = 0,
            n = F;
          (n.INSERT = V), (n.DELETE = Z), (n.EQUAL = W), (t.exports = n);
        },
        function (t, e) {
          function n(t) {
            var e,
              ...
              (r(l, [
                {
                  ...
                  value: function (t) {
                    var a = this,
                      s = !1,
                      u = (this.scroll.update(), this.scroll.length());
                    return (
                      ...
                      (t = t.reduce(function (t, e) {
                        ...
                        return 1 !== e.insert
                          ? (null == e.attributes ||
                              ...
                              ((e = (0, v.default)(e)).attributes.list
                          ...
                          : (delete (n = (0, v.default)(e.attributes)).image,
                        ...
                        if (null != t.insert) {
                          if ("string" == typeof t.insert) {
                            (r = t.insert).endsWith("\n") &&
                              ...
                              ((s = !1), (r = r.slice(0, -1))),
                              u <= e && !r.endsWith("\n") && (s = !0),
                              a.scroll.insertAt(e, r);
                            var r = (l = c(a.scroll.line(e), 2))[0],
                              i = l[1],
                              l = (0, g.default)({}, (0, y.bubbleFormats)(r));
                            r instanceof b.default &&
                              ((i = c(r.descendant(d.default.Leaf, i), 1)[0]),
                              (l = (0, g.default)(l, (0, y.bubbleFormats)(i)))),
                              (o = p.default.attributes.diff(l, o) || {});
                          } else if ("object" === f(t.insert)) {
                            if (null == (l = Object.keys(t.insert)[0]))
                              return e;
                      ...
                      t.reduce(function (t, e) {
                        return "number" == typeof e.delete
                          ? (a.scroll.deleteAt(t, e.delete), t)
                  ...
                  value: function (l, e) {
                    ...
                    return (
                      ...
                      Object.keys(s).forEach(function (r) {
                        var t, i;
                        (null != a.scroll.whitelist &&
                          !a.scroll.whitelist[r]) ||
                          ...
                          t.forEach(function (t) {
                            var e,
                              ...
                              o = t.length();
                            t instanceof u.default
                              ? ((e = l - t.offset(a.scroll)),
                                (n = t.newlineIndex(e + i) - e + 1),
                                t.formatAt(e, n, r, s[r]))
                              : t.format(r, s[r]),
                              (i -= o);
                          }));
                      }),
                      this.scroll.optimize(),
                      this.update(
                        new h.default().retain(l).retain(e, (0, v.default)(s))
                      )
                    );
                  },
                },
                {
                  ...
                  value: function (e, n) {
                    ...
                    return (
                      ...
                      this.update(
                        new h.default().retain(e).retain(n, (0, v.default)(r))
                      )
                    );
                  },
                },
                    ...
                    return (
                      0 === e
                        ? this.scroll.path(t).forEach(function (t) {
                            (t = c(t, 1)[0]) instanceof b.default
                              ? n.push(t)
                              : t instanceof d.default.Leaf && o.push(t);
                          })
                        : ((n = this.scroll.lines(t, e)),
                          (o = this.scroll.descendants(d.default.Leaf, t, e))),
                      (e = [n, o].map(function (t) {
                        if (0 === t.length) return {};
                        for (
                          var e = (0, y.bubbleFormats)(t.shift());
                          0 < Object.keys(e).length;
                ...
                },
                {
                  ...
                  value: function (e, n) {
                    ...
                    return (
                      ...
                      this.update(
                        new h.default().retain(e).insert(n, (0, v.default)(r))
                      )
                    );
                  },
                },
                {
                  ...
                  value: function () {
                    var t;
                    return (
                      0 == this.scroll.children.length ||
                      (!(
                        1 < this.scroll.children.length ||
                        (t = this.scroll.children.head).statics.blotName !==
                          b.default.blotName ||
                        1 < t.children.length
                      ) &&
                        t.children.head instanceof i.default)
                    );
                  },
                },
                {
                  ...
                  value: function (t, e) {
                    var n = this.getText(t, e),
                      o = (l = c((i = this.scroll.line(t + e)), 2))[0],
                      r = l[1],
                      i = 0,
                      l = new h.default();
                    return (
                      null != o &&
                        ((i =
                          o instanceof u.default
                            ? o.newlineIndex(r) - r + 1
                            : o.length() - r),
                        (l = o
                          .delta()
                          .slice(r, r + i - 1)
                          .insert("\n"))),
                      (l = this.getContents(t, e + i).diff(
                        new h.default().insert(n).concat(l)
                      )),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return (
                      ...
                      r[0].target.data.match(m) &&
                      d.default.find(r[0].target)
                        ...
                        : ((this.delta = this.getDelta()),
                          (t && (0, s.default)(l.compose(t), this.delta)) ||
                            (t = l.diff(this.delta, i))),
                      t
                    );
                  },
                },
          ...
          Object.create &&
            ...
            (n.prototype.eventNames = function () {
              ...
              for (e in (t = this._events))
                r.call(t, e) && n.push(p ? e.slice(1) : e);
            ...
            (n.prototype.emit = function (t, e, n, o, r, i) {
              ...
              if (s.fn) {
                switch (
                  (s.once && this.removeListener(t, s.fn, void 0, !0), u)
                ) {
                  case 1:
                ...
                for (var c, f = s.length, h = 0; h < f; h++)
                  switch (
                    (s[h].once && this.removeListener(t, s[h].fn, void 0, !0),
                    u)
                  ) {
                    case 1:
            ...
            (n.prototype.on = function (t, e, n) {
              return (
                ...
                this._events[t]
                  ...
                  : ((this._events[t] = n), this._eventsCount++),
                this
              );
            }),
              ...
              if (((t = p ? p + t : t), this._events[t]))
                if (e) {
                  ...
                  if (r.fn)
                    ...
                    for (var i = 0, l = [], a = r.length; i < a; i++)
                      (r[i].fn !== e ||
                        (o && !r[i].once) ||
                        (n && r[i].context !== n)) &&
                        l.push(r[i]);
                    l.length
                      ? (this._events[t] = 1 === l.length ? l[0] : l)
                      : 0 == --this._eventsCount
                      ? (this._events = new s())
                      : delete this._events[t];
                  }
            ...
            if (this instanceof d)
              return (
                ((t = (function (t, e) {
                  ...
                  this,
                  (d.__proto__ || Object.getPrototypeOf(d)).call(this, t)
                )).emitter = e.emitter),
          ...
          (b.prototype = Object.create(v && v.prototype, {
            ...
            r(d, [
              ...
              },
              {
                key: "deleteAt",
                value: function (t, e) {
                  var n = (r = s(this.line(t), 2))[0],
                    o = r[1],
                    r = s((r = this.line(t + e)), 1)[0];
                  if (
                    (a(
                    ...
                    if (n instanceof c.BlockEmbed || r instanceof c.BlockEmbed)
                      return void this.optimize();
                    if (n instanceof p.default) {
                      if (
                        -1 < (o = n.newlineIndex(n.length(), !0)) &&
                        (n = n.split(o + 1)) === r
                      )
                        return void this.optimize();
                    } else
                      r instanceof p.default &&
                        -1 < (i = r.newlineIndex(0)) &&
                        r.split(i + 1);
                    var i =
                      r.children.head instanceof h.default
                        ? null
                        : r.children.head;
                    n.moveChildren(r, i), n.remove();
                  }
                  this.optimize();
                },
              },
              ...
              },
              {
                key: "formatAt",
                value: function (t, e, n, o) {
                  (null != this.whitelist && !this.whitelist[n]) ||
                    (a(
                      d.prototype.__proto__ ||
                        Object.getPrototypeOf(d.prototype),
                      "formatAt",
              ...
              },
              {
                ...
                value: function (t, e, n) {
                  var o;
                  (null != n && null != this.whitelist && !this.whitelist[e]) ||
                    (t >= this.length()
                      ? null == n ||
                        null == u.default.query(e, u.default.Scope.BLOCK)
                        ? ((o = u.default.create(this.statics.defaultChild)),
                          this.appendChild(o),
                          null == n && e.endsWith("\n") && (e = e.slice(0, -1)),
                          o.insertAt(0, e, n))
                        : ((o = u.default.create(e, n)), this.appendChild(o))
                      : a(
                          d.prototype.__proto__ ||
                            Object.getPrototypeOf(d.prototype),
                          "insertAt",
              ...
              },
              {
                ...
                value: function (t, e) {
                  var n;
                  t.statics.scope === u.default.Scope.INLINE_BLOT &&
                    ((n = u.default.create(
                  ...
                  return (function o(t, e, n) {
                    ...
                    return (
                      t.children.forEachAt(e, n, function (t, e, n) {
                        l(t)
                          ? r.push(t)
                          : t instanceof u.default.Container &&
                            (r = r.concat(o(t, e, i))),
                          (i -= n);
                      }),
                      r
              ...
              },
              {
                ...
                value: function () {
                  ...
                  !0 !== this.batch &&
                    ...
                    0 < t.length) &&
                    this.emitter.emit(i.default.events.SCROLL_OPTIMIZE, t, e);
                },
              },
              {
                key: "path",
              ...
              },
              {
                ...
                value: function (t) {
                  var e;
                  !0 !== this.batch &&
                    ((e = i.default.sources.USER),
                    "string" == typeof t && (e = t),
                    0 <
                      (t = Array.isArray(t) ? t : this.observer.takeRecords())
                        .length &&
                      this.emitter.emit(
                        i.default.events.SCROLL_BEFORE_UPDATE,
                        e,
                        t
                      ),
                    a(
                    ...
                    0 < t.length) &&
                    this.emitter.emit(i.default.events.SCROLL_UPDATE, e, t);
                },
              },
            ]),
            ((r = d).blotName = "scroll"),
        ...
        function (R, t, e) {
            ...
            return "object" === (void 0 === n ? "undefined" : y(n))
              ...
              : t.reduce(function (t, e) {
                  return e.attributes && e.attributes[n]
                    ...
                    : t.insert(
                        e.insert,
                        (0, v.default)({}, r({}, n, o), e.attributes)
                      );
                }, new g.default());
          }
          function i(t) {
          ...
          function a(t, e) {
            for (
              var n = "", o = t.ops.length - 1;
              0 <= o && n.length < e.length;
              --o
            ) {
              var r = t.ops[o];
          ...
          function s(t) {
            return (
              ...
              -1 < ["block", "list-item"].indexOf(i(t).display)
            );
          }
          function o(t, e, n) {
            return l(n, t, !0);
          ...
          function u(n, t) {
            var e = m.default.Attributor.Attribute.keys(n),
              o = m.default.Attributor.Class.keys(n),
              r = m.default.Attributor.Style.keys(n),
              i = {};
            return (
              e
                .concat(o)
                .concat(r)
                .forEach(function (t) {
                  var e = m.default.query(t, m.default.Scope.ATTRIBUTE);
                  (null != e &&
                    ((i[e.attrName] = e.value(n)), i[e.attrName])) ||
                    (null == (e = S[t]) ||
                      (e.attrName !== t && e.keyName !== t) ||
                      (i[e.attrName] = e.value(n) || void 0),
                    null == (e = C[t])) ||
                    (e.attrName !== t && e.keyName !== t) ||
                    ((e = C[t]), (i[e.attrName] = e.value(n) || void 0));
                }),
          ...
          function c(t, e) {
            ...
            return (
              null != r &&
                (r.prototype instanceof m.default.Embed
                  ? ((n = {}),
                    null != (o = r.value(t)) &&
                      ((n[r.blotName] = o),
                      (e = new g.default().insert(n, r.formats(t)))))
                  : "function" == typeof r.formats &&
                    (e = l(e, r.blotName, r.formats(t)))),
              e
            );
          }
          function f(t, e) {
            return (
              a(e, "\n") ||
                ((s(t) ||
                  (0 < e.length() && t.nextSibling && s(t.nextSibling))) &&
                  e.insert("\n")),
              e
            );
          }
          function h(t, e) {
            ...
            return (
              s(t) &&
                ...
                ((n =
                  t.offsetHeight +
                  parseFloat(i(t).marginTop) +
                  parseFloat(i(t).marginBottom)),
          ...
          var y =
            ...
            P = [
              ...
              [
                ...
                function (t, e) {
                  ...
                  return (
                    o.fontStyle &&
                      "italic" === i(t).fontStyle &&
                      (n.italic = !0),
                    o.fontWeight &&
                      (i(t).fontWeight.startsWith("bold") ||
                        700 <= parseInt(i(t).fontWeight)) &&
                      (n.bold = !0),
                    0 < Object.keys(n).length && (e = l(e, n)),
                    0 < parseFloat(o.textIndent || 0)
                      ? new g.default().insert("\t").concat(e)
                      : e
                  );
                },
              ],
              [
                "li",
                function (t, e) {
                  var n = m.default.query(t);
                  if (null == n || "list-item" !== n.blotName || !a(e, "\n"))
                    return e;
                  for (
                    var o = -1, r = t.parentNode;
                    !r.classList.contains("ql-clipboard");

                  )
                    "list" === (m.default.query(r) || {}).blotName && (o += 1),
                      (r = r.parentNode);
                  return o <= 0
                    ? e
                    : e.compose(
            ...
            S = [x.AlignAttribute, j.DirectionAttribute].reduce(function (
              t,
              e
            ) {
            ...
            if (this instanceof L)
              return (
                (o = (function (t, e) {
                  ...
                  this,
                  (L.__proto__ || Object.getPrototypeOf(L)).call(this, t, n)
                )).quill.root.addEventListener("paste", o.onPaste.bind(o)),
                ...
                (o.matchers = []),
                P.concat(o.options.matchers).forEach(function (t) {
                  var t = (e = d(t, 2))[0],
                    e = e[1];
                  (!n.matchVisual && e === h) || o.addMatcher(t, e);
                }),
                o
              );
            throw new TypeError("Cannot call a class as a function");
          ...
          (O.prototype = Object.create(x && x.prototype, {
                  ...
                  return "string" == typeof t
                    ...
                    ? ((e = this.container.innerText),
                      ...
                      new g.default().insert(
                        e,
                        r({}, E.default.blotName, t[E.default.blotName])
                      ))
                    : ((e = this.prepareMatching()),
                      ...
                      a(
                        ...
                        (t = t.compose(
                          new g.default().retain(t.length() - 1).delete(1)
                        )),
                      q.log("convert", this.container.innerHTML, t),
                      (this.container.innerHTML = ""),
                      t);
                },
              },
                ...
                value: function (t, e) {
                  ...
                  "string" == typeof t
                    ? (this.quill.setContents(this.convert(t), e),
                      this.quill.setSelection(0, _.default.sources.SILENT))
                    : ((e = this.convert(e)),
                      this.quill.updateContents(
                        new g.default().retain(t).concat(e),
                        n
                      ),
                      this.quill.setSelection(
                        t + e.length(),
                        _.default.sources.SILENT
                      ));
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  !t.defaultPrevented &&
                    ...
                    (n = new g.default().retain(e.index)),
                    (o = this.quill.scrollingContainer.scrollTop),
                    this.container.focus(),
                    this.quill.selection.update(_.default.sources.SILENT),
                    setTimeout(function () {
                      (n = n.concat(r.convert()).delete(e.length)),
                        r.quill.updateContents(n, _.default.sources.USER),
                  ...
                  return (
                    this.matchers.forEach(function (t) {
                      ...
                      switch (e) {
                        ...
                        default:
                          [].forEach.call(
                            o.container.querySelectorAll(e),
                            function (t) {
                              (t[T] = t[T] || []), t[T].push(n);
                            }
                          );
            ...
            ((b = L).DEFAULTS = { matchers: [], matchVisual: !0 }),
            (t.default = b),
            (t.matchAttributor = u),
            (t.matchBlot = c),
            (t.matchNewline = f),
        ...
        function (t, e, n) {
            ...
            if (this instanceof s)
              return (
                ((r = (function (t, e) {
                  ...
                  this,
                  (s.__proto__ || Object.getPrototypeOf(s)).call(this, t, e)
                )).lastRecorded = 0),
                (r.ignoreChange = !1),
                r.clear(),
                r.quill.on(
          ...
          (c.prototype = Object.create(n && n.prototype, {
            constructor: {
              value: c,
              enumerable: !1,
              writable: !0,
            ...
            i(s, [
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  0 !== t.ops.length &&
                    ((this.stack.redo = []),
                    (o = this.quill.getContents().diff(e)),
                    (n = Date.now()),
                    this.lastRecorded + this.options.delay > n &&
                    0 < this.stack.undo.length
                      ? ((e = this.stack.undo.pop()),
                        (o = o.compose(e.undo)),
                        (t = e.redo.compose(t)))
                      : (this.lastRecorded = n),
                    this.stack.undo.push({ redo: t, undo: o }),
            ...
            ((i = s).DEFAULTS = { delay: 1e3, maxStack: 100, userOnly: !1 }),
            (e.default = i),
        ...
        function (t, e, n) {
          ...
          (function (t, e) {
            ...
            o,
            (n = (n = n(0)) && n.__esModule ? n : { default: n }).default
              .Attributor.Class
          ),
            i(o.prototype, [
              {
        ...
        function (t, e, n) {
          ...
          Object.defineProperty(e, "__esModule", { value: !0 });
          var r = o,
            i = ((n = n(3)) && n.__esModule ? n : { default: n }).default;
          if ("function" != typeof i && null !== i)
            throw new TypeError(
              "Super expression must either be null or a function, not " +
                typeof i
        ...
        function (t, e, n) {
          ...
          var l = r,
            n = ((n = n(3)) && n.__esModule ? n : { default: n }).default;
          if ("function" != typeof n && null !== n)
            throw new TypeError(
              "Super expression must either be null or a function, not " +
                typeof n
        ...
        function (t, e, n) {
                ...
                [
                  {
                    ...
                    value: function (t, e) {
                      t !== d.blotName || e
                        ...
                        : this.replaceWith(
                            u.default.create(this.statics.scope)
                          );
                    },
                  },
                  {
                    ...
                    value: function (t, e) {
                      return (
                        ...
                        t === this.parent.statics.blotName
                          ? (this.parent.replaceWith(t, e), this)
                          : (this.parent.unwrap(),
                            a(
                              h.prototype.__proto__ ||
                                Object.getPrototypeOf(h.prototype),
          ...
          function h() {
            return (
              ...
              i(
                this,
                (h.__proto__ || Object.getPrototypeOf(h)).apply(this, arguments)
              )
            );
          }
          function p(t, e) {
                ...
                value: function (t) {
                  ...
                  return (
                    ("checked" !== t && "unchecked" !== t) ||
                      e.setAttribute("data-checked", "checked" === t),
                    e
                  );
                },
              },
            ...
            s(y, [
              ...
              },
              {
                ...
                value: function (t, e) {
                  t instanceof f
                    ...
                    : ((e = null == e ? this.length() : e.offset(this)),
                      (e = this.split(e)).parent.insertBefore(t, e));
                },
              },
              {
                key: "optimize",
              ...
              },
              {
                ...
                value: function (t) {
                  var e;
                  t.statics.blotName !== this.statics.blotName &&
                    ((e = u.default.create(this.statics.defaultChild)),
                    t.moveChildren(e),
                    this.appendChild(e)),
                    a(
                      y.prototype.__proto__ ||
          ...
          function y(n) {
            function t(t) {
              ...
              t.target.parentNode === n &&
                ((e = o.statics.formats(n)),
                (t = u.default.find(t.target)),
                "checked" === e
                  ? t.format("list", "unchecked")
                  : "unchecked" === e && t.format("list", "checked"));
            }
            r(this, y);
            var o = i(
              this,
          ...
          (d.blotName = "list"),
            (d.scope = u.default.Scope.BLOCK_BLOT),
            (d.tagName = ["OL", "UL"]),
        ...
        function (t, e, n) {
          ...
          Object.defineProperty(e, "__esModule", { value: !0 });
          var r = o,
            i = ((n = n(39)) && n.__esModule ? n : { default: n }).default;
          if ("function" != typeof i && null !== i)
            throw new TypeError(
              "Super expression must either be null or a function, not " +
                typeof i
            ...
            o(
              ...
              [
                ...
                },
                {
                  key: "sanitize",
                  value: function (t) {
                    return (0, l.sanitize)(t, ["http", "https", "data"])
                      ? t
                      : "//:0";
                  },
                },
        ...
        function (t, e, n) {
          ...
          function f() {
            return (
              ...
              i(
                this,
                (f.__proto__ || Object.getPrototypeOf(f)).apply(this, arguments)
              )
            );
          }
          function h(t, e) {
        ...
        function (t, e, n) {
              ...
              a(h, [
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    this.cachedText !== e &&
                      ((0 < e.trim().length || null == this.cachedText) &&
          ...
          function y(t, e) {
            ...
            var n = i(
              this,
              (y.__proto__ || Object.getPrototypeOf(y)).call(this, t, e)
            );
            ...
            a(y, [
              {
                ...
                value: function () {
                  ...
                  this.quill.selection.composing ||
                    ...
                    null != t &&
                      this.quill.setSelection(t, u.default.sources.SILENT));
                },
              },
            ]),
            ((a = y).DEFAULTS = {
                    ...
                    : ((n = t[(e = Object.keys(t)[0])]),
                      Array.isArray(n)
                        ? ((o = l),
                          (r = e),
                          (t = n),
                          (i = document.createElement("select")).classList.add(
                            "ql-" + r
                          ),
                          t.forEach(function (t) {
                            var e = document.createElement("option");
          ...
          function d(t, e) {
            ...
            if (this instanceof d)
              return (
                (n = r(
                  this,
                  (d.__proto__ || Object.getPrototypeOf(d)).call(this, t, e)
                )),
                Array.isArray(n.options.container)
                  ? (i(
                  ...
                  ? (n.container = document.querySelector(n.options.container))
                  : (n.container = n.options.container),
                n.container instanceof HTMLElement
                  ? (n.container.classList.add("ql-toolbar"),
                    ...
                    [].forEach.call(
                      n.container.querySelectorAll("button, select"),
                      function (t) {
                        n.attach(t);
                      }
                    ),
                    ...
                    n)
                  : ((o = p.error("Container required for toolbar", n.options)),
                    r(n, o))
              );
            throw new TypeError("Cannot call a class as a function");
          }
                ...
                value: function (i) {
                  ...
                  if (a) {
                    if (
                      ...
                      null == this.handlers[a])
                    ) {
                      if (
                        null != this.quill.scroll.whitelist &&
                        null == this.quill.scroll.whitelist[a]
                      )
                        return void p.warn(
                    ...
                    i.addEventListener(t, function (t) {
                      ...
                      if (null != l.handlers[a]) l.handlers[a].call(l, e);
                        ...
                        c.default.query(a).prototype instanceof c.default.Embed
                      ) {
                ...
                value: function (r) {
                  ...
                  this.controls.forEach(function (t) {
                    var e,
                      n = s(t, 2),
                      o = n[0];
                    "SELECT" === (t = n[1]).tagName
                      ? ((e = void 0),
                        null == r
                          ? (e = null)
                          : null == i[o]
                          ? (e = t.querySelector("option[selected]"))
                          : Array.isArray(i[o]) ||
                            ("string" == typeof (n = i[o]) &&
                              (n = n.replace(/\"/g, '\\"')),
                            (e = t.querySelector('option[value="' + n + '"]'))),
                        null == e
                          ? ((t.value = ""), (t.selectedIndex = -1))
                          : (e.selected = !0))
                      : null == r
                      ? t.classList.remove("ql-active")
                      : t.hasAttribute("value")
                      ? ((e =
                          i[o] === t.getAttribute("value") ||
                          (null != i[o] &&
                            i[o].toString() === t.getAttribute("value")) ||
                          (null == i[o] && !t.getAttribute("value"))),
                        t.classList.toggle("ql-active", e))
                      : t.classList.toggle("ql-active", null != i[o]);
                  });
                },
              },
            ]),
              ...
              handlers: {
                    ...
                    (0 == n.length
                      ? ((t = this.quill.getFormat()),
                        Object.keys(t).forEach(function (t) {
                          null != c.default.query(t, c.default.Scope.INLINE) &&
                            e.quill.format(t, !1);
                        }))
                ...
                direction: function (t) {
                  ...
                  "rtl" === t && null == e
                    ...
                    : t ||
                      "right" !== e ||
                      this.quill.format("align", !1, f.default.sources.USER),
                    this.quill.format("direction", t, f.default.sources.USER);
                },
                indent: function (t) {
                  ...
                  ("+1" !== t && "-1" !== t) ||
                    ((t = "+1" === t ? 1 : -1),
                    "rtl" === n.direction && (t *= -1),
                    this.quill.format("indent", e + t, f.default.sources.USER));
                },
                link: function (t) {
                ...
                list: function (t) {
                  ...
                  "check" === t
                    ...
                    : this.quill.format("list", t, f.default.sources.USER);
                },
              },
            }),
            (e.default = l),
        ...
        function (t, e, n) {
          ...
          function b(t, e) {
            return (
              ...
              null != e.modules.toolbar &&
                ...
                (e.modules.toolbar.container = y),
              (e = l(
                this,
                (b.__proto__ || Object.getPrototypeOf(b)).call(this, t, e)
              )).quill.container.classList.add("ql-bubble"),
              e
            );
          }
          function v(t, e) {
          ...
          r(b, h.default),
            ...
            ((n = b).DEFAULTS = (0, u.default)(!0, {}, h.default.DEFAULTS, {
              modules: {
                toolbar: {
                  handlers: {
                    link: function (t) {
          ...
          function m(t, e) {
            ...
            var r = l(
              this,
              (m.__proto__ || Object.getPrototypeOf(m)).call(this, t, e)
            );
            return (
              r.quill.on(c.default.events.EDITOR_CHANGE, function (t, e, n, o) {
                t === c.default.events.SELECTION_CHANGE &&
                  (null != e && 0 < e.length && o === c.default.sources.USER
                    ? (r.show(),
                      (r.root.style.left = "0px"),
                      (r.root.style.width = ""),
                      (r.root.style.width = r.root.offsetWidth + "px"),
                      1 === (t = r.quill.getLines(e.index, e.length)).length
                        ? r.position(r.quill.getBounds(e))
                        : ((o = t[t.length - 1]),
                          (t = r.quill.getIndex(o)),
                          (e = Math.min(
                            o.length() - 1,
                            e.index + e.length - t
                          )),
                          (e = r.quill.getBounds(new p.Range(t, e))),
                          r.position(e)))
        ...
        function (t, e, n) {
          ...
          function v(t, e) {
            return (
              ...
              null != e.modules.toolbar &&
                null == e.modules.toolbar.container &&
                (e.modules.toolbar.container = b),
              (e = i(
                this,
                (v.__proto__ || Object.getPrototypeOf(v)).call(this, t, e)
          ...
          l(v, h.default),
            ...
            ((n = v).DEFAULTS = (0, u.default)(!0, {}, h.default.DEFAULTS, {
              modules: {
                toolbar: {
                  handlers: {
                    link: function (t) {
                      t
                        ? null != (t = this.quill.getSelection()) &&
                          0 != t.length &&
                          ((t = this.quill.getText(t)),
                          /^\S+@\S+\.\S+$/.test(t) &&
                            0 !== t.indexOf("mailto:") &&
                            (t = "mailto:" + t),
                          this.quill.theme.tooltip.edit("link", t))
                        : this.quill.format("link", !1);
                    },
                  },
                },
                  ...
                  a(
                    ...
                    this.root
                      ...
                      .addEventListener("click", function (t) {
                        r.root.classList.contains("ql-editing")
                          ? r.save()
                          : r.edit("link", r.preview.textContent),
                          t.preventDefault();
                      }),
                    this.root
                    ...
                    this.quill.on(
                      c.default.events.SELECTION_CHANGE,
                      function (t, e, n) {
                        if (null != t) {
                          if (0 === t.length && n === c.default.sources.USER) {
                            ...
                            if (null != o)
                              return (
                                (r.linkRange = new d.Range(
                                  t.index - n,
                                  o.length()
                                )),
                                (o = p.default.formats(o.domNode)),
                                (r.preview.textContent = o),
                                r.preview.setAttribute("href", o),
                                r.show(),
                                void r.position(r.quill.getBounds(r.linkRange))
                              );
          ...
          function _(t, e) {
            return (
              ...
              ((e = i(
                this,
                (_.__proto__ || Object.getPrototypeOf(_)).call(this, t, e)
              )).preview = e.root.querySelector("a.ql-preview")),
              e
            );
          }
          (m.TEMPLATE = [
