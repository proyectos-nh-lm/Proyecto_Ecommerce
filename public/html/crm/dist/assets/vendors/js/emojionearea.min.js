  ...
  (function (e, a) {
    ...
    function R(o, n, t, i) {
      (i =
        i ||
        function (e, a) {
          return x(a.currentTarget);
        }),
        x.each(t, function (e, a) {
          (e = x.isArray(t) ? a : e),
            (s[o.id][a] || (s[o.id][a] = [])).push([n, e, i]);
        });
    }
    function r(e, a, o) {
      var n = C.imageType,
        t = "svg" == n ? C.imagePathSVG : C.imagePathPNG,
        i = "",
        r =
          (o &&
            (i = o
      ...
      return (
        a.uc_base && 4 < S
          ? ((r = a.uc_base), (a = a.uc_output.toUpperCase()))
          : (r = a),
        e
          .replace("{name}", o || "")
          .replace("{friendlyName}", i)
          .replace("{img}", t + (S < 2 ? r.toUpperCase() : r) + "." + n)
          .replace("{uni}", a)
          .replace("{alt}", C.convert(a))
      );
    }
    function F(e, o, n) {
      return e.replace(/:?\+?[\w_\-]+:?/g, function (e) {
        e = ":" + e.replace(/:$/, "").replace(/^:/, "") + ":";
        var a = C.emojioneList[e];
        return a
          ? 4 < S
            ? r(o, a, e)
            : (3 < S && (a = a.unicode), r(o, a[a.length - 1], e))
          : n
          ? ""
          : e;
      });
    ...
    function B(e) {
      ...
      if (window.getSelection) {
        if ((a = window.getSelection()).getRangeAt && a.rangeCount) {
          ...
          n.innerHTML = e;
          for (
            var t, i, r = document.createDocumentFragment();
            (t = n.firstChild);
          ...
          o.insertNode(r),
            i &&
              ((o = o.cloneRange()).setStartAfter(i),
              o.collapse(!0),
              a.removeAllRanges(),
              a.addRange(o));
        }
    ...
    function o() {
      var e, a;
      return x.fn.emojioneArea && x.fn.emojioneArea.defaults
        ? x.fn.emojioneArea.defaults
        : ((e = {
            attributes: {
              dir: "ltr",
              spellcheck: !1,
    ...
    function O(e) {
      ...
      return (
        e &&
          e.filters &&
          ((n = a.filters),
          x.each(e.filters, function (o, e) {
            return !D(e) || x.isEmptyObject(e)
              ? void delete n[o]
              : void x.each(e, function (e, a) {
                  n[o][e] = a;
                });
          }),
          (e.filters = n)),
    ...
    function u(e, o) {
      return e.replace(i, function (e) {
        var a = C[0 === S ? "jsecapeMap" : "jsEscapeMap"];
        return void 0 !== e && e in a ? r(o, a[e]) : e;
      });
    }
    function I(e, a) {
      return (
        ...
        u((e = a.shortnames ? C.shortnameToUnicode(e) : e), a.emojiTemplate)
          .replace(/\t/g, "&nbsp;&nbsp;&nbsp;&nbsp;")
          .replace(/  /g, "&nbsp;&nbsp;")
      );
    }
    ...
    function L() {
      ...
      o !== a &&
        (e.button.css({ marginRight: a }), e.floatingPicker) &&
        e.picker.css({ right: parseInt(e.picker.css("right")) - o + a });
    }
    function U() {
      var o,
        n,
    ...
    function V(e) {
      var o = x("<div/>", D(e) ? e : { class: $(e, !0) });
      return (
        x.each(_.call(arguments).slice(1), function (e, a) {
          (a = x.isFunction(a) ? a.call(o) : a) && x(a).appendTo(o);
        }),
        o
      );
    }
    ...
    function M(e, a) {
      ...
      (e.recent && e.recent === i && !a) ||
        (i.length
          ? ((t = e.scrollArea.is(".skinnable")) ||
              ((o = e.scrollArea.scrollTop()),
              a && e.recentCategory.show(),
              (n = e.recentCategory.is(":visible")
                ? e.recentCategory.height()
                : 0)),
            (a = F(i, e.emojiBtnTemplate, !0).split("|").join("")),
            e.recentCategory.children(".emojibtn").remove(),
            x(a).insertAfter(
              e.recentCategory.children(".emojionearea-category-title")
            ),
            e.recentCategory.children(".emojibtn").on("click", function () {
              e.trigger("emojibtn.click", x(this));
            }),
            e.recentFilter.show(),
            t ||
              (e.recentCategory.show(),
              n !== (t = e.recentCategory.height()) &&
                e.scrollArea.scrollTop(o + t - n)))
          : (e.recentFilter.hasClass("active") &&
              e.recentFilter.removeClass("active").next().addClass("active"),
            e.recentCategory.hide(),
            e.recentFilter.hide()),
        (e.recent = i));
    }
    window.getSelection && document.createRange
      ? ((z = function (e) {
        ...
        (T = function (e, a) {
          ...
          o.setStart(a.startContainer, a.startOffset),
      ...
      : document.selection &&
        ...
        (T = function (e, a) {
          ...
          o.moveToElementText(e),
            o.setStart(a.startContanier, a.startOffset),
            o.setEnd(a.endContainer, a.endOffset),
            o.select();
        }));
    var d = {
        ...
        d.isLoading ||
          (!C || g(m(C)) < 2
            ? ((d.isLoading = !0),
              (e =
                5 < g(o)
                  ? d.defaultBase3 + "npm/emojione@" + o
                  : 4 < g(o)
                  ? d.defaultBase3 + "emojione/" + o
                  : d.defaultBase + "/" + o),
              x.ajax({
                ...
                success: function () {
                  ...
                  for (
                    C = window.emojione,
                      ...
                      e =
                        4 < (S = g(o))
                          ? ((d.base = d.defaultBase3 + "emojione/assets/" + o),
                            d.base +
                              "/sprites/emojione-sprite-" +
                              C.emojiSize +
                              ".css")
                          : ((d.base = d.defaultBase + o + "/assets"),
                            d.base + "/sprites/emojione.sprites.css"),
                      a.sprite &&
            ...
            : ((o = m(C)),
              ...
              (d.base =
                4 < S
                  ? d.defaultBase3 + "emojione/assets/" + o
                  : d.defaultBase + o + "/assets"))),
        t(function () {
          var e = "";
          a.useInternalCDN &&
            (4 < S && (e = C.emojiSize + "/"),
            (C.imagePathPNG = d.base + "/png/" + e),
            (C.imagePathSVG = d.base + "/svg/" + e),
            (C.imagePathSVGSprites = d.base + "/sprites/emojione.sprites.svg"),
            (C.imageType = a.imageType)),
            4 < g(o)
              ? ((i = C.regUnicode), (C.imageType = a.imageType || "png"))
              : (i = new RegExp(
    ...
    function a(y, v) {
      ...
      p(v),
        ...
        (s[j.id] = {}),
        t(function () {
          var l, a, i, e, t, o, r, s, _, n, c, m, g, u, d, p, f, h, b, w, k;
          (a = y),
            (i = v),
            ((l = j).options = i = O(i)),
            (l.sprite = i.sprite && S < 3),
            ...
            (e = i.pickerPosition),
            (l.floatingPicker = "top" === e || "bottom" === e),
            ((l.source = a).is(":disabled") || a.is(".disabled")) &&
              l.disable(),
            ...
            (f = V(
              ...
              (o = l.button =
                V("button", V("button-open"), V("button-close")).attr(
                  "title",
                  i.buttonTitle
                )),
              (r = l.picker =
                V(
                  ...
                  V(
                    ...
                    (u = V(
                      "scroll-area",
                      i.tones && !i.search ? V("tones-panel", p) : null,
                      (c = V("emojis-list"))
                    ))
                  )
                )
            ...
            i.search && n.addClass($("with-search", !0)),
            (l.searchSel = null),
            t.data(a.data()),
            x.each(i.attributes, function (e, a) {
              t.attr(e, a);
            }),
            (h = V("category-block").attr({ "data-tone": 0 }).prependTo(c)),
            x.each(i.filters, function (e, a) {
              var o = 0;
              if ("recent" !== e || l.recentEmojis) {
                if ("tones" !== e)
                  x("<i/>", {
                    class: $("filter", !0) + " " + $("filter-" + e, !0),
                    "data-filter": e,
                    title: a.title,
                  })
                    .wrapInner(F(a.icon, l.emojiTemplateAlt))
                    .appendTo(s);
                else {
                  if (!i.tones) return;
                  o = 5;
                ...
                do {
                  ...
                  (0 < o &&
                    (t.hide(),
                    (n = n.split("|").join("_tone" + o + "|") + "_tone" + o)),
                  (n = F(
                    (n = "recent" === e ? G() : n),
                    l.sprite
                    ...
                    .join("")),
                  t.html(n),
                  x('<div class="emojionearea-category-title"/>')
                    .text(a.title)
                    .prependTo(t),
                  0 < --o)
                );
            ...
            (_ = s.find($("filter"))).eq(0).addClass("active"),
            (g = c.find($("category-block"))),
            (m = c.find($("category"))),
            (l.recentFilter = _.filter('[data-filter="recent"]')),
            (l.recentCategory = m.filter("[name=recent]")),
            (l.scrollArea = u),
            i.container ? x(i.container).wrapInner(f) : f.insertAfter(a),
            i.hideSource && a.hide(),
            l.setText(a[d]()),
            a[d](l.getText()),
            L.apply(l),
            l.standalone &&
              !l.getText().length &&
              ((w = x(a).data("emoji-placeholder") || i.emojiPlaceholder),
              l.setText(w),
              t.addClass("has-placeholder")),
            R(l, c.find(".emojibtn"), { click: "emojibtn.click" }),
            R(l, window, { resize: "!resize" }),
            R(l, p.children(), { click: "tone.click" }),
            R(l, [r, o], { mousedown: "!mousedown" }, t),
            R(l, o, { click: "button.click" }),
            R(l, t, { paste: "!paste" }, t),
            R(l, t, ["focus", "blur"], function () {
            ...
            R(l, r.find(".emojionearea-filter"), { click: "filter.click" }),
            R(l, a, { change: "source.change" }),
            i.search &&
              R(l, l.search, {
            ...
            u.on("scroll", function () {
              var o, n, e;
              !k &&
                (U.call(l), u.is(":not(.skinnable)")) &&
                ((o = m.eq(0)),
                (n = u.offset().top),
                m.each(function (e, a) {
                  return !(10 <= x(a).offset().top - n) && void (o = x(a));
                }),
                (e = _.filter('[data-filter="' + o.attr("name") + '"]'))[0] &&
                  !e.is(".active") &&
                  (_.removeClass("active"), e.addClass("active")));
            }),
            l
              .on("@filter.click", function (e) {
                ...
                (k = !0),
                  a ||
                    (_.filter(".active").removeClass("active"),
                    e.addClass("active"));
                var o = m
                    .filter('[name="' + e.data("filter") + '"]')
                    .offset().top,
                  a = u.scrollTop(),
                  e = u.offset().top;
                u.stop().animate(
              ...
              .on("@tone.click", function (e) {
                p.children().removeClass("active"),
                  (e = e.addClass("active").data("skin"))
                    ...
                    : (u.removeClass("skinnable"),
                      g.hide().filter("[data-tone=0]").show(),
                      _.eq(0).click()),
                  U.call(l),
              ...
              .on("@!paste", function (i, e) {
                ...
                (l.stayFocused = !0), B("<span>" + P + "</span>");
                var o = z(i[0]),
                  r = i.scrollTop(),
                  n = x("<div/>", { contenteditable: !0 })
                    .css({
                      position: "fixed",
                      left: "-999px",
                      width: "1px",
              ...
              .on("@emojibtn.click", function (e) {
                ...
                t.removeClass("has-placeholder"),
                  null !== l.searchSel &&
                    (t.focus(), T(t[0], l.searchSel), (l.searchSel = null)),
                  l.standalone
                    ? (t.html(F(e.data("name"), l.emojiTemplate)),
                      l.trigger("blur"))
                    : (z(t[0]), B(F(e.data("name"), l.emojiTemplate))),
                  l.recentEmojis &&
                    ((a = l),
                    (o = e.data("name")),
                    -1 !== (e = (n = G().split("|")).indexOf(o)) &&
                      n.splice(e, 1),
                    n.unshift(o),
                    9 < n.length && n.pop(),
                    localStorage.setItem("recent_emojis", n.join("|")),
                    M(a)),
                  l.trigger("search.keypress");
              })
              .on("@!resize @keyup @emojibtn.click", L)
              .on("@!mousedown", function (e, a) {
                return (
                  x(a.target).hasClass("search")
                    ? ((l.stayFocused = !0),
                      null === l.searchSel && (l.searchSel = z(e[0])))
                    : (f.is(".focused") || e.trigger("focus"),
                      a.preventDefault()),
                  !1
                );
              })
              .on("@change", function () {
                ...
                (e.length && !/^<br[^>]*>$/i.test(e)) ||
                  l.editor.html((l.content = "")),
                  a[d](l.getText());
              })
              .on("@source.change", function () {
                l.setText(a[d]()), E("change");
              })
              .on("@focus", function () {
                f.addClass("focused");
              })
              .on("@blur", function () {
                ...
                l.content !== e
                  ? ((l.content = e),
                    E(l, "change", [l.editor]),
                    a.trigger("blur").trigger("change"))
                  : a.trigger("blur"),
                  i.search &&
                    (l.search.val(""), l.trigger("search.keypress", !0));
              }),
            i.search &&
              l
                ...
                .on("@search.keypress", function (e) {
                  ...
                  t && t.length
                    ? (l.recentFilter.hasClass("active") &&
                        l.recentFilter
                          .removeClass("active")
                          .next()
                          .addClass("active"),
                      ...
                      g.each(function () {
                        function e(e, a) {
                          ...
                          0 === o.length
                            ? (e.data("tone") === a && e.hide(),
                              n
                                .filter(
                                  '[data-filter="' + e.attr("name") + '"]'
                                )
                                .hide())
                            : (e
                                .find('.emojibtn:not([data-name*="' + t + '"])')
                                .hide(),
                              o.show(),
                              e.data("tone") === a && e.show(),
                              n
                                .filter(
                                  '[data-filter="' + e.attr("name") + '"]'
                                )
                      ...
                      k ? U.call(l) : u.trigger("scroll"))
                    : (M(l, !0),
                      g
                        .filter(
                          '[data-tone="' +
                            p.find("i.active").data("skin") +
                            '"]:not([name="recent"])'
                        )
                        .show(),
                      x(".emojibtn", g).show(),
              ...
              l.on("@keydown", function (e, a) {
                a.ctrlKey ||
                  (9 == a.which
                    ...
                    : 27 == a.which &&
                      (a.preventDefault(), o.is(".active")) &&
                      l.hidePicker());
              }),
            D(i.events) &&
              !x.isEmptyObject(i.events) &&
              x.each(i.events, function (e, a) {
              ...
              ((b = function () {
                var e = {
                  ...
                  o =
                    ...
                    x.map(C.emojioneList, function (e, a) {
                      return !i.autocompleteTones && /_tone[12345]/.test(a)
                        ? null
                        : a;
                    }));
                o.sort(),
                    ...
                    [
                      {
                        ...
                        template: function (e) {
                          return (
                            F(e, l.emojiTemplate) + " " + e.replace(/:/g, "")
                          );
                        },
                        replace: function (e) {
                          return F(e, l.emojiTemplate);
                        },
                        cache: !0,
                        index: 1,
                      },
                  ...
                  i.textcomplete.placement &&
                    "static" ==
                      x(t.data("textComplete").option.appendTo).css(
                        "position"
                      ) &&
                    x(t.data("textComplete").option.appendTo).css(
                      "position",
    ...
    (a.prototype.on = function (e, i) {
      var r;
      return (
        e &&
          x.isFunction(i) &&
          ((r = this),
          x.each(e.toLowerCase().split(" "), function (e, a) {
            var n, t, o;
            (n = r),
              (t = (t = a).replace(/^@/, "")),
              (o = n.id),
              s[o][t] &&
                (x.each(s[o][t], function (e, o) {
                  x.each(x.isArray(o[0]) ? o[0] : [o[0]], function (e, a) {
                    x(a).on(o[1], function () {
                      var e = _.call(arguments),
                        a = x.isFunction(o[2])
                          ? o[2].apply(n, [t].concat(e))
                          : o[2];
                      a && E(n, t, [a].concat(e));
                    });
                  });
      ...
      (a.prototype.off = function (e, n) {
        ...
        return (
          e &&
            ((t = this.id),
            x.each(
              e.toLowerCase().replace(/_/g, ".").split(" "),
              function (e, o) {
                l[t][o] &&
                  !/^@/.test(o) &&
                  (n
                    ? x.each(l[t][o], function (e, a) {
                        a === n && (l[t][o] = l[t][o].splice(e, 1));
                      })
                    : (l[t][o] = []));
              }
            )),
      ...
      (a.prototype.trigger = function () {
        ...
        return a.push(e.slice(1)), E.apply(this, a);
      }),
      ...
      (a.prototype.getText = function () {
        return N(this.editor.html(), this);
      }),
      ...
      (a.prototype.enable = function () {
        function e() {
          ...
          e.parent().removeClass("emojionearea-disable"), E(a, "enabled", [e]);
        }
        var a = this;
      ...
      (a.prototype.disable = function () {
        ...
        function e() {
          ...
          var e = a[a.standalone ? "button" : "editor"];
          e.parent().addClass("emojionearea-disable"), E(a, "disabled", [e]);
        }
        return (a.disabled = !0), a.isReady ? e() : a.on("ready", e), a;
      }),
      (x.fn.emojioneArea = function (e) {
        return this.each(function () {
          return (
            ...
            (x.data(
              this,
              "emojioneArea",
              (this.emojioneArea = new a(x(this), e))
            ),
            this.emojioneArea)
          );
        });
      }),
      (x.fn.emojioneArea.defaults = o()),
      (x.fn.emojioneAreaText = function (e) {
        e = O(e);
        var a = this,
          o = {
        ...
        return (
          ...
          t(function () {
            a.each(function () {
              var e = x(this);
              return (
                e.hasClass("emojionearea-text") ||
                  e
                    .addClass("emojionearea-text")
                    .html(
                      I(
                        e.is("TEXTAREA") || e.is("INPUT") ? e.val() : e.text(),
                        o
                      )
                    ),
                e
