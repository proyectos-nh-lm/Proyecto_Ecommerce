...
var tomailmodal = document.querySelector("input[name=tomailmodal]"),
  ...
  tomailcontent = document.querySelector("input[name=tomailcontent]"),
  ccmailcontent = document.querySelector("input[name=ccmailcontent]"),
  bccmailcontent = document.querySelector("input[name=bccmailcontent]"),
  userlist = [
    {
      value: 1,
      name: "WrapCoders",
      avatar:
        "https://en.gravatar.com/userimage/217650896/f011e8341437035d5063e32a126cb70d.png",
...
$(document).ready(function () {
  ...
  t.on("dropdown:select", function (a) {
    console.log(this),
      console.log(
        a.detail.elm.className,
  ...
  $(document).ready(function () {
    var t = new Tagify(tomailcontent, {
      tagTextProp: "name",
      enforceWhitelist: !0,
      skipInvalid: !0,
      dropdown: {
  ...
  $(document).ready(function () {
    var t = new Tagify(ccmailcontent, {
      tagTextProp: "name",
      enforceWhitelist: !0,
      skipInvalid: !0,
      dropdown: {
  ...
  $(document).ready(function () {
    var t = new Tagify(bccmailcontent, {
      tagTextProp: "name",
      enforceWhitelist: !0,
      skipInvalid: !0,
      dropdown: {
