!(function (y) {
  ...
  y.extend(e.prototype, {
    init: function () {
      ...
      this.updateHeader(e, a),
        n.append(a),
        this.buildCalendar(e, n),
        t.append(n),
        this.bindEvents(),
    ...
    buildCalendar: function (t, e) {
      var n = this,
        a = (e.find("table").remove(), y("<table></table>")),
        s = y("<thead></thead>"),
        i = y("<tbody></tbody>"),
        d = t.getFullYear(),
        r = t.getMonth(),
      ...
      if (!1 !== this.settings.fixedStartDay) {
        ...
        for (; o.getDay() !== (l + 6) % 7; ) o.setDate(o.getDate() + 1);
      }
      for (var c = l; c < l + 7; c++)
        s.append(
          y("<td>" + this.settings.days[c % 7].substring(0, 3) + "</td>")
        );
      for (var u = h; u <= o; u.setDate(u.getDate())) {
        for (var v = y("<tr></tr>"), c = 0; c < 7; c++) {
          var f = y(
            ...
            D =
              (u.toDateString() === new Date().toDateString() &&
                g.addClass("today"),
              u.getMonth() != t.getMonth() && g.addClass("wrong-month"),
              n.getDateEvents(u));
          D.length && n.settings.displayEvent
            ? g.addClass(
                n.settings.disableEventDetails
                  ? "has-event disabled"
                  : "has-event"
              )
            : g.addClass(n.settings.disableEmptyDetails ? "disabled" : ""),
            g.data("todayEvents", D),
            this.settings.onDayCreate(g, u.getDate(), r, d),
            v.append(f),
    ...
    changeMonth: function (t) {
      this.currentDate.setMonth(this.currentDate.getMonth() + t, 1),
        this.buildCalendar(this.currentDate, y(this.element).find(".calendar")),
        this.updateHeader(
          this.currentDate,
          y(this.element).find(".calendar header")
        ),
      ...
      y(a.element).off(),
        ...
        y(a.element).on("click", ".day", function (t) {
          ...
          y(this).hasClass("disabled") ||
            (a.fillUp(t.pageX, t.pageY), a.displayEvents(n)),
            a.settings.onDateSelect(e, n);
        }),
    ...
    displayEvents: function (t) {
      var a = this,
        s = y(this.element).find(".event-wrapper");
        ...
        var e = new Date(t.startDate),
          ...
          e = y(
            '<div class="event"> <div class="event-hour">' +
              ...
              a.formatDateEvent(e, n) +
              '</div> <div class="event-summary">' +
              t.summary +
              "</div></div>"
          );
        e.data("event", t),
          e.click(a.settings.onEventSelect),
          a.settings.onEventCreate(e),
          s.append(e);
      });
    },
    addEvent: function (t) {
      (this.settings.events = [...this.settings.events, t]),
        this.buildCalendar(this.currentDate, y(this.element).find(".calendar"));
    },
    setEvents: function (t) {
      (this.settings.events = t),
        this.buildCalendar(this.currentDate, y(this.element).find(".calendar"));
    },
    fillUp: function (t, e) {
      ...
      s.css("left", t - a.left),
        s.css("top", e - a.top),
        n.find(".calendar").append(s),
        s.animate({ width: "300%", height: "300%" }, 500, function () {
    ...
    empty: function (t, e) {
      ...
      a.css("width", "300%"),
        a.css("height", "300%"),
        a.show(),
        n.find(".event-container").hide().find(".event").remove(),
        a.animate({ width: "0%", height: "0%" }, 500, function () {
          a.remove();
        });
    },
    ...
    (y.fn[n] = function (t) {
      return this.each(function () {
        y.data(this, "plugin_" + n) ||
          y.data(this, "plugin_" + n, new e(this, t));
      });
    });
