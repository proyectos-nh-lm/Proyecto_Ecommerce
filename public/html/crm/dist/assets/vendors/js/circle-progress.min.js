...
!(function (i) {
              ...
              switch (t.nodeType) {
                case 1:
                  return (
                    ...
                    (n += "<" + (i = t).tagName),
                    i.hasAttributes() &&
                      [].forEach.call(i.attributes, function (t) {
                        n += " " + t.name + '="' + t.value + '"';
                      }),
                    (n += ">"),
                    i.hasChildNodes() &&
  ...
  (a = {
    ...
    (r = function (t, e, i, n, r) {
      ...
      return (
        (r = r || document),
        ((a = Object.create(s)).el = r.createElementNS(
  ...
  var a,
    ...
    n = function (t, e, i, n) {
      ...
      if (
        ((n = n || document),
        (r = Object.create(a)),
        (t = "string" == typeof t ? n.querySelector(t) : t))
      )
        return (
          (n = n.createElementNS(
            "http://www.w3.org/2000/svg",
          ...
          e && n.setAttribute("width", e),
          i && n.setAttribute("height", i),
          e && i && n.setAttribute("viewBox", "0 0 " + e + " " + i),
          t.appendChild(n),
          (r.svg = n),
          r
        );
    ...
    _createClass(
      ...
      [
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            this._attrs[t] === e ||
              ...
              t in i &&
                (void 0 !== e
                  ? this.el.setAttribute(i[t], e)
                  : this.el.removeAttribute(i[t])),
        ...
        },
        {
          key: "_valueToAngle",
          value: function (t) {
            t = 0 < arguments.length && void 0 !== t ? t : this.value;
            return Math.min(
              360,
              ...
              : ((e = this.clockwise),
                ...
                "none" !== this.animation && this.value !== this.graph.value
                  ? h(
                      ...
                      function (t) {
                        n._updateText(Math.round(t), (2 * r + i) / 2, a),
                          (i = n._valueToAngle(t)),
                          n.graph.sector.attr(
                            "d",
                            o._makeSectorPath(50, 50, a, r, i, e)
                          );
                      }
                    )
                  : (this.graph.sector.attr(
                    ...
                    this._updateText(this.value, (2 * r + i) / 2, a)),
      ...
      [
        {
          ...
          value: function (t, e, i, n, r, a) {
            ...
            var s = n + r * (2 * (a = !!a) - 1),
              n = u.polarToCartesian(i, n),
              s = u.polarToCartesian(i, s),
              o = t + n.x,
              t = t + s.x;
            return [
              "M",
  ...
  function o(t) {
    ...
    ((t.circleProgress = this).doc = i),
      ...
      (this.graph.sector = this.graph.paper
        .element("path")
        .attr({
          d: o._makeSectorPath(50, 50, 50 - i / 2, 0, 0),
  ...
  (e = function (h) {
    ...
    (h.cleanData =
      ...
      (h.widget = function (t, i, e) {
        ...
        return (
          ...
          ((s = new i()).options = h.widget.extend({}, s.options)),
          ...
          r
            ? (h.each(r._childConstructors, function (t, e) {
                var i = e.prototype;
                h.widget(i.namespace + "." + i.widgetName, a, e._proto);
              }),
      ...
      (h.Widget.prototype = {
        ...
        option: function (t, e) {
          ...
          if ("string" == typeof t)
            if (((a = {}), (t = (i = t.split(".")).shift()), i.length)) {
              for (
                n = a[t] = h.widget.extend({}, this.options[t]), r = 0;
                r < i.length - 1;
                r++
              )
                (n[i[r]] = n[i[r]] || {}), (n = n[i[r]]);
        ...
        _on: function (r, a, t) {
          ...
          "boolean" != typeof r && ((t = a), (a = r), (r = !1)),
            t
              ? ((a = s = h(a)), (this.bindings = this.bindings.add(a)))
              : ((t = a), (a = this.element), (s = this.widget())),
            h.each(t, function (t, e) {
              ...
              var t = t.match(/^([\w:-]*)\s*(.*)$/),
                n = t[1] + o.eventNamespace,
                t = t[2];
              t ? s.delegate(t, n, i) : a.bind(n, i);
            });
        },
        _off: function (t, e) {
          (e =
      ...
      h.each({ show: "fadeIn", hide: "fadeOut" }, function (a, s) {
        h.Widget.prototype["_" + a] = function (e, t, i) {
          var n,
            r = (t = "string" == typeof t ? { effect: t } : t)
              ? (!0 !== t && "number" != typeof t && t.effect) || s
              : a;
          "number" == typeof (t = t || {}) && (t = { duration: t }),
            (n = !h.isEmptyObject(t)),
            (t.complete = i),
            t.delay && e.delay(t.delay),
            n && h.effects && h.effects.effect[r]
              ? e[a](t)
              : r !== a && e[r]
              ? e[r](t.duration, t.easing, i)
              : e.queue(function (t) {
                  h(this)[a](), i && i.call(e[0]), t();
                });
        };
      }),
      h.widget;
  }),
    "function" == typeof define && define.amd ? define(["jquery"], e) : e(t),
    t.widget("tl.circleProgress", {
      options: t.extend({}, i.defaults),
      _create: function () {
        (this.circleProgress = new i(this.element[0], this.options)),
    ...
    (t.fn.circleProgress.defaults = i.defaults);
});
