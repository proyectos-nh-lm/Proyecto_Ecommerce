!(function (t, a) {
  ...
  function i(t, e, a) {
    ...
    if (
      ...
      "string" == typeof (e = L.extend(this.element.data(), e)).template ||
        e.template instanceof L ||
        (e.template =
          '<div class="daterangepicker"><div class="ranges"></div><div class="drp-calendar left"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-calendar right"><div class="calendar-table"></div><div class="calendar-time"></div></div><div class="drp-buttons"><span class="drp-selected"></span><button class="cancelBtn" type="button"></button><button class="applyBtn" disabled="disabled" type="button"></button> </div></div>'),
      (this.parentEl =
        e.parentEl && L(e.parentEl).length ? L(e.parentEl) : L(this.parentEl)),
      (this.container = L(e.template).appendTo(this.parentEl)),
      ...
      "string" == typeof e.startDate &&
        (this.startDate = A(e.startDate, this.locale.format)),
      "string" == typeof e.endDate &&
        (this.endDate = A(e.endDate, this.locale.format)),
      "string" == typeof e.minDate &&
        (this.minDate = A(e.minDate, this.locale.format)),
      "string" == typeof e.maxDate &&
        (this.maxDate = A(e.maxDate, this.locale.format)),
      "object" == typeof e.startDate && (this.startDate = A(e.startDate)),
      "object" == typeof e.endDate && (this.endDate = A(e.endDate)),
      "object" == typeof e.minDate && (this.minDate = A(e.minDate)),
      "object" == typeof e.maxDate && (this.maxDate = A(e.maxDate)),
      this.minDate &&
      ...
      "boolean" == typeof e.singleDatePicker &&
        ((this.singleDatePicker = e.singleDatePicker), this.singleDatePicker) &&
    ...
    if (
      (void 0 === e.startDate &&
        void 0 === e.endDate &&
        L(this.element).is(":text") &&
        ((o = s = null),
        2 ==
        (r = (t = L(this.element).val()).split(this.locale.separator)).length
          ? ((o = A(r[0], this.locale.format)),
            (s = A(r[1], this.locale.format)))
          : this.singleDatePicker &&
            "" !== t &&
            ((o = A(t, this.locale.format)), (s = A(t, this.locale.format))),
        null !== o) &&
        null !== s &&
        (this.setStartDate(o), this.setEndDate(s)),
      "object" == typeof e.ranges)
    ) {
      for (n in e.ranges) {
        (o =
          "string" == typeof e.ranges[n][0]
            ? A(e.ranges[n][0], this.locale.format)
            : A(e.ranges[n][0])),
          (s =
            "string" == typeof e.ranges[n][1]
              ? A(e.ranges[n][1], this.locale.format)
              : A(e.ranges[n][1])),
          this.minDate &&
        ...
        var l,
          c = this.maxDate;
        (c =
          this.maxSpan && c && o.clone().add(this.maxSpan).isAfter(c)
            ? o.clone().add(this.maxSpan)
            : c) &&
          s.isAfter(c) &&
          (s = c.clone()),
          (this.minDate &&
            s.isBefore(this.minDate, this.timepicker ? "minute" : "day")) ||
            (c && o.isAfter(c, this.timepicker ? "minute" : "day")) ||
            (((l = document.createElement("textarea")).innerHTML = n),
            (i = l.value),
            (this.ranges[i] = [o, s]));
      }
      var d = "<ul>";
      for (n in this.ranges)
        d += '<li data-range-key="' + n + '">' + n + "</li>";
      this.showCustomRangeLabel &&
        (d +=
          ...
          "</li>"),
        (d += "</ul>"),
        this.container.find(".ranges").prepend(d);
    }
    "function" == typeof a && (this.callback = a),
      ...
      this.container
        .find(".drp-calendar")
        .on("click.daterangepicker", ".prev", L.proxy(this.clickPrev, this))
        .on("click.daterangepicker", ".next", L.proxy(this.clickNext, this))
        .on(
          "mousedown.daterangepicker",
          "td.available",
          L.proxy(this.clickDate, this)
        )
        .on(
          "mouseenter.daterangepicker",
          "td.available",
          L.proxy(this.hoverDate, this)
        )
        .on(
          "change.daterangepicker",
          "select.yearselect",
          L.proxy(this.monthOrYearChanged, this)
        )
        .on(
          "change.daterangepicker",
          "select.monthselect",
        ...
        .on(
          ...
          L.proxy(this.timeChanged, this)
        ),
      this.container
        .find(".ranges")
        .on("click.daterangepicker", "li", L.proxy(this.clickRange, this)),
      this.container
        .find(".drp-buttons")
        .on(
          "click.daterangepicker",
          "button.applyBtn",
          L.proxy(this.clickApply, this)
        )
        .on(
          "click.daterangepicker",
          "button.cancelBtn",
          L.proxy(this.clickCancel, this)
        ),
      this.element.is("input") || this.element.is("button")
        ...
        : (this.element.on("click.daterangepicker", L.proxy(this.toggle, this)),
          this.element.on(
  ...
  return (
    (i.prototype = {
      ...
      setStartDate: function (t) {
        "string" == typeof t && (this.startDate = A(t, this.locale.format)),
          ...
          this.minDate &&
            this.startDate.isBefore(this.minDate) &&
            ((this.startDate = this.minDate.clone()), this.timePicker) &&
            this.timePickerIncrement &&
            this.startDate.minute(
              Math.round(this.startDate.minute() / this.timePickerIncrement) *
                this.timePickerIncrement
          ...
          this.maxDate &&
            ...
            ((this.startDate = this.maxDate.clone()), this.timePicker) &&
            this.timePickerIncrement &&
            this.startDate.minute(
      ...
      setEndDate: function (t) {
        "string" == typeof t && (this.endDate = A(t, this.locale.format)),
      ...
      renderCalendar: function (t) {
        var e,
          ...
          h = A([i, a, 1]),
          i = A([i, a, o]),
          a = A(h).subtract(1, "month").month(),
          o = A(h).subtract(1, "month").year(),
          l = A([o, a]).daysInMonth(),
          c = h.day();
        ((e = []).firstDay = h), (e.lastDay = i);
        for (var d = 0; d < 6; d++) e[d] = [];
        h = l - c + this.locale.firstDay + 1;
        l < h && (h -= 7), c == this.locale.firstDay && (h = l - 6);
        for (
          var m = A([o, a, h, 12, n, r]), p = (d = 0), f = 0;
          d < 42;
          d++, p++, m = A(m).add(24, "hour")
        )
          0 < d && p % 7 == 0 && ((p = 0), f++),
            (e[f][p] = m.clone().hour(s).minute(n).second(r)),
            m.hour(12),
            this.minDate &&
              e[f][p].format("YYYY-MM-DD") ==
                this.minDate.format("YYYY-MM-DD") &&
              e[f][p].isBefore(this.minDate) &&
              "left" == t &&
              (e[f][p] = this.minDate.clone()),
            this.maxDate &&
              e[f][p].format("YYYY-MM-DD") ==
                this.maxDate.format("YYYY-MM-DD") &&
              e[f][p].isAfter(this.maxDate) &&
              "right" == t &&
              (e[f][p] = this.maxDate.clone());
        "left" == t
        ...
        var u = "left" == t ? this.minDate : this.startDate,
          ...
          i =
            ...
            (this.showWeekNumbers || this.showISOWeekNumbers) &&
              (g += "<th></th>"),
            (u && !u.isBefore(e.firstDay)) ||
            (this.linkedCalendars && "left" != t)
              ? (g += "<th></th>")
              : (g += '<th class="prev available"><span></span></th>'),
            this.locale.monthNames[e[1][1].month()] + e[1][1].format(" YYYY"));
        if (this.showDropdowns) {
          for (
            var y = e[1][1].month(),
              k = e[1][1].year(),
              b = (D && D.year()) || this.maxYear,
              c = (u && u.year()) || this.minYear,
              C = k == c,
              v = k == b,
              Y = '<select class="monthselect">',
              w = 0;
            w < 12;
            w++
          )
            (!C || (u && w >= u.month())) && (!v || (D && w <= D.month()))
              ? (Y +=
                  "<option value='" +
                  w +
                  "'" +
                  (w === y ? " selected='selected'" : "") +
                  ">" +
              ...
              : (Y +=
                  ...
                  "</option>");
          Y += "</select>";
          for (var P = '<select class="yearselect">', x = c; x <= b; x++)
            P +=
              '<option value="' +
              x +
              '"' +
              (x === k ? ' selected="selected"' : "") +
              ">" +
              x +
              "</option>";
          i = Y + (P += "</select>");
        ...
        for (
          g += '<th colspan="5" class="month">' + i + "</th>",
            (D && !D.isAfter(e.lastDay)) ||
            (this.linkedCalendars && "right" != t && !this.singleDatePicker)
              ? (g += "<th></th>")
              : (g += '<th class="next available"><span></span></th>'),
            g += "</tr><tr>",
            (this.showWeekNumbers || this.showISOWeekNumbers) &&
              (g += '<th class="week">' + this.locale.weekLabel + "</th>"),
            L.each(this.locale.daysOfWeek, function (t, e) {
              g += "<th>" + e + "</th>";
            }),
            g += "</tr></thead><tbody>",
            null == this.endDate &&
              this.maxSpan &&
              ((l = this.startDate.clone().add(this.maxSpan).endOf("day")),
              (D && !l.isBefore(D)) || (D = l)),
            f = 0;
          f < 6;
          f++
          ...
          for (
            g += "<tr>",
              this.showWeekNumbers
                ? (g += '<td class="week">' + e[f][0].week() + "</td>")
                : this.showISOWeekNumbers &&
                  (g += '<td class="week">' + e[f][0].isoWeek() + "</td>"),
              p = 0;
            p < 7;
            p++
          ) {
            for (
              var M = [],
                I =
                  (e[f][p].isSame(new Date(), "day") && M.push("today"),
                  5 < e[f][p].isoWeekday() && M.push("weekend"),
                  e[f][p].month() != e[1][1].month() && M.push("off", "ends"),
                  this.minDate &&
                    e[f][p].isBefore(this.minDate, "day") &&
                    M.push("off", "disabled"),
                  D && e[f][p].isAfter(D, "day") && M.push("off", "disabled"),
                  this.isInvalidDate(e[f][p]) && M.push("off", "disabled"),
                  e[f][p].format("YYYY-MM-DD") ==
                    this.startDate.format("YYYY-MM-DD") &&
                    M.push("active", "start-date"),
                  null != this.endDate &&
                    e[f][p].format("YYYY-MM-DD") ==
                      this.endDate.format("YYYY-MM-DD") &&
                    M.push("active", "end-date"),
                  null != this.endDate &&
                    e[f][p] > this.startDate &&
                    e[f][p] < this.endDate &&
                    M.push("in-range"),
                  this.isCustomDate(e[f][p])),
                S =
                  (!1 !== I &&
                    ("string" == typeof I
                      ? M.push(I)
                      : Array.prototype.push.apply(M, I)),
                  ""),
                B = !1,
                d = 0;
              d < M.length;
      ...
      renderTimePicker: function (t) {
        if ("right" != t || this.endDate) {
          ...
          !this.maxSpan ||
            ...
            "left" == t
              ? ((e = this.startDate.clone()), (a = this.minDate))
              : "right" == t &&
                ((e = this.endDate.clone()),
                (a = this.startDate),
                "" ==
                  (r = this.container.find(
                    ".drp-calendar.right .calendar-time"
                  )).html() ||
                  (e.hour(
                    isNaN(e.hour())
                      ? r.find(".hourselect option:selected").val()
                      : e.hour()
                  ),
                  e.minute(
                    isNaN(e.minute())
                      ? r.find(".minuteselect option:selected").val()
                      : e.minute()
                  ),
                  e.second(
                    isNaN(e.second())
                      ? r.find(".secondselect option:selected").val()
                      : e.second()
                  ),
                  this.timePicker24Hour) ||
                  ("PM" === (r = r.find(".ampmselect option:selected").val()) &&
                    e.hour() < 12 &&
                    e.hour(e.hour() + 12),
                  "AM" === r && 12 === e.hour() && e.hour(0)),
                e.isBefore(this.startDate) && (e = this.startDate.clone()),
                i) &&
                e.isAfter(i) &&
                (e = i.clone());
          for (
            ...
            var l = h,
              c =
                (this.timePicker24Hour ||
                  (l =
                    12 <= e.hour() ? (12 == h ? 12 : h + 12) : 12 == h ? 0 : h),
                e.clone().hour(l)),
              d = !1;
            a && c.minute(59).isBefore(a) && (d = !0),
              i && c.minute(0).isAfter(i) && (d = !0),
              l != e.hour() || d
                ? (n += d
                    ? '<option value="' +
                      h +
          ...
          for (
            n = n + "</select> " + ': <select class="minuteselect">', h = 0;
            h < 60;
            ...
            var m = h < 10 ? "0" + h : h,
              c = e.clone().minute(h),
              d = !1;
            a && c.second(59).isBefore(a) && (d = !0),
              i && c.second(0).isAfter(i) && (d = !0),
              e.minute() != h || d
                ? (n += d
                    ? '<option value="' +
                      h +
          ...
          if (((n += "</select> "), this.timePickerSeconds)) {
            for (n += ': <select class="secondselect">', h = 0; h < 60; h++)
              (m = h < 10 ? "0" + h : h),
                (c = e.clone().second(h)),
                (d = !1),
                a && c.isBefore(a) && (d = !0),
          ...
          this.timePicker24Hour ||
            ...
            (s = r = ""),
            a &&
              e.clone().hour(12).minute(0).second(0).isBefore(a) &&
              (r = ' disabled="disabled" class="disabled"'),
            i &&
              e.clone().hour(0).minute(0).second(0).isAfter(i) &&
              (s = ' disabled="disabled" class="disabled"'),
            12 <= e.hour()
              ? (n +=
                  '<option value="AM"' +
                  r +
        ...
        this.container.toggleClass("drop-up", "up" == a),
          "left" == this.opens
            ? n +
              ...
              : this.container.css({ top: t, right: i, left: "auto" })
            : "center" == this.opens
            ? (s =
            ...
            : (s = this.element.offset().left - e.left) + n > L(window).width()
            ? this.container.css({ top: t, left: "auto", right: 0 })
            : this.container.css({ top: t, left: s, right: "auto" });
      },
      show: function (t) {
        this.isShowing ||
          ((this._outsideClickProxy = L.proxy(function (t) {
            this.outsideClick(t);
          }, this)),
          L(document)
      ...
      hide: function (t) {
        this.isShowing &&
          ...
          this.updateElement(),
          L(document).off(".daterangepicker"),
          L(window).off(".daterangepicker"),
          this.container.hide(),
      ...
      clickRange: function (t) {
        var t = t.target.getAttribute("data-range-key");
      ...
      clickPrev: function (t) {
        (L(t.target).parents(".drp-calendar").hasClass("left") &&
      ...
      clickNext: function (t) {
        (L(t.target).parents(".drp-calendar").hasClass("left") ||
          (this.rightCalendar.month.add(1, "month"), this.linkedCalendars)) &&
          this.leftCalendar.month.add(1, "month"),
          this.updateCalendars();
      },
      hoverDate: function (t) {
        var e, a, s, n, r, o;
        L(t.target).hasClass("available") &&
          ((e = (a = L(t.target).attr("data-title")).substr(1, 1)),
          (a = a.substr(3, 1)),
          (s = (
            L(t.target).parents(".drp-calendar").hasClass("left")
              ? this.leftCalendar
          ...
          this.endDate ||
            this.container.find(".drp-calendar tbody td").each(function (t, e) {
              var a, i;
              L(e).hasClass("week") ||
                ((i = (a = L(e).attr("data-title")).substr(1, 1)),
                (a = a.substr(3, 1)),
                ((i = (L(e).parents(".drp-calendar").hasClass("left") ? n : r)
                  .calendar[i][a]).isAfter(o) &&
                  i.isBefore(s)) ||
                i.isSame(s, "day")
                  ? L(e).addClass("in-range")
                  : L(e).removeClass("in-range"));
            }));
      },
      clickDate: function (t) {
        var e, a, i, s, n, r;
        L(t.target).hasClass("available") &&
          ((s = (e = L(t.target).attr("data-title")).substr(1, 1)),
          (e = e.substr(3, 1)),
          (s = (
            L(t.target).parents(".drp-calendar").hasClass("left")
              ? this.leftCalendar
          ...
          this.endDate || s.isBefore(this.startDate, "day")
            ? (this.timePicker &&
                ...
                (i = this.timePickerSeconds
                  ...
                  : 0),
                (s = s.clone().hour(r).minute(a).second(i))),
              (this.endDate = null),
          ...
          this.singleDatePicker &&
            (this.setEndDate(this.startDate), !this.timePicker) &&
            this.autoApply &&
            this.clickApply(),
          this.updateView(),
          t.stopPropagation());
        ...
        for (t in this.ranges) {
          if (this.timePicker) {
            var i = this.timePickerSeconds
              ...
              : "YYYY-MM-DD HH:mm";
            if (
              this.startDate.format(i) == this.ranges[t][0].format(i) &&
              this.endDate.format(i) == this.ranges[t][1].format(i)
            ) {
              (e = !1),
            ...
            this.startDate.format("YYYY-MM-DD") ==
              this.ranges[t][0].format("YYYY-MM-DD") &&
            this.endDate.format("YYYY-MM-DD") ==
              this.ranges[t][1].format("YYYY-MM-DD")
          ) {
            (e = !1),
              (this.chosenLabel = this.container
                .find(".ranges li:eq(" + a + ")")
      ...
      monthOrYearChanged: function (t) {
        var t = L(t.target).closest(".drp-calendar").hasClass("left"),
          e = this.container.find(".drp-calendar." + (t ? "left" : "right")),
          a = parseInt(e.find(".monthselect").val(), 10),
          e = e.find(".yearselect").val();
        t ||
          ((e < this.startDate.year() ||
            (e == this.startDate.year() && a < this.startDate.month())) &&
            ((a = this.startDate.month()), (e = this.startDate.year()))),
          this.minDate &&
            (e < this.minDate.year() ||
              (e == this.minDate.year() && a < this.minDate.month())) &&
            ((a = this.minDate.month()), (e = this.minDate.year())),
          this.maxDate &&
            (e > this.maxDate.year() ||
              (e == this.maxDate.year() && a > this.maxDate.month())) &&
            ((a = this.maxDate.month()), (e = this.maxDate.year())),
          t
            ? (this.leftCalendar.month.month(a).year(e),
              this.linkedCalendars &&
                (this.rightCalendar.month = this.leftCalendar.month
                  .clone()
                  .add(1, "month")))
            : (this.rightCalendar.month.month(a).year(e),
              this.linkedCalendars &&
      ...
      timeChanged: function (t) {
        var t = L(t.target).closest(".drp-calendar"),
          e = t.hasClass("left"),
          a = parseInt(t.find(".hourselect").val(), 10),
          i = parseInt(t.find(".minuteselect").val(), 10),
          s =
            (isNaN(i) &&
              (i = parseInt(t.find(".minuteselect option:last").val(), 10)),
            this.timePickerSeconds
              ? parseInt(t.find(".secondselect").val(), 10)
              : 0);
        this.timePicker24Hour ||
          ("PM" === (t = t.find(".ampmselect").val()) && a < 12 && (a += 12),
          "AM" === t && 12 === a && (a = 0)),
          e
            ? ((t = this.startDate.clone()).hour(a),
              t.minute(i),
              t.second(s),
              this.setStartDate(t),
              this.singleDatePicker
                ? (this.endDate = this.startDate.clone())
                : this.endDate &&
                  this.endDate.format("YYYY-MM-DD") == t.format("YYYY-MM-DD") &&
                  this.endDate.isBefore(t) &&
                  this.setEndDate(t.clone()))
            : this.endDate &&
              ((e = this.endDate.clone()).hour(a),
              e.minute(i),
              e.second(s),
              this.setEndDate(e)),
          this.updateCalendars(),
      ...
      elementChanged: function () {
        ...
        this.element.is("input") &&
          ...
          2 === (t = this.element.val().split(this.locale.separator)).length &&
            ((e = A(t[0], this.locale.format)),
            (a = A(t[1], this.locale.format))),
          (!this.singleDatePicker && null !== e && null !== a) ||
            (a = e = A(this.element.val(), this.locale.format)),
          e.isValid()) &&
          a.isValid() &&
